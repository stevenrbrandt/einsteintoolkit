                          ...
                          void* const output_values[])
{
  ...
  int dim = 0;
  CCTK_INT proc;
  CCTK_INT num_points=0;
  CCTK_INT total_num_points = 1;
  CCTK_INT perform_division = 1;
  CCTK_INT perform_2_root   = 1;
  CCTK_INT perform_3_root   = 1;
  CCTK_INT perform_4_root   = 1;      
  CCTK_INT perform_all_reduce = 1;
  pGA *GA;
  int created_local_par_table = 0;

  /* weight variables */
  CCTK_INT weight_variable_index;
  CCTK_INT weight_on = 0;
...
#ifdef CCTK_MPI
  CCTK_INT nprocs = 0, global_operation = 0;
