...
#if defined(HAVE_CCTK_INT1) && defined(HAVE_CCTK_INT2)
CONVERSION_FUNCTION (INT2, INT1, CONVERT)
#endif
#if defined(HAVE_CCTK_INT1) && defined(HAVE_CCTK_INT4)
CONVERSION_FUNCTION (INT4, INT1, CONVERT)
#endif
#if defined(HAVE_CCTK_INT2) && defined(HAVE_CCTK_INT4)
CONVERSION_FUNCTION (INT4, INT2, CONVERT)
#endif
#if defined(HAVE_CCTK_INT1) && defined(HAVE_CCTK_INT8)
CONVERSION_FUNCTION (INT8, INT1, CONVERT)
#endif
#if defined(HAVE_CCTK_INT2) && defined(HAVE_CCTK_INT8)
CONVERSION_FUNCTION (INT8, INT2, CONVERT)
#endif
#if defined(HAVE_CCTK_INT4) && defined(HAVE_CCTK_INT8)
CONVERSION_FUNCTION (INT8, INT4, CONVERT)
#endif

/* predefined conversion functions for reals */
#if defined(HAVE_CCTK_REAL4) && defined(HAVE_CCTK_REAL8)
CONVERSION_FUNCTION (REAL8, REAL4, CONVERT)
#endif
#if defined(HAVE_CCTK_REAL4) && defined(HAVE_CCTK_REAL16)
CONVERSION_FUNCTION (REAL16, REAL4, CONVERT)
#endif
#if defined(HAVE_CCTK_REAL8) && defined(HAVE_CCTK_REAL16)
