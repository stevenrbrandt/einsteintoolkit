...
static void TestLoopPointwise_All(CCTK_ARGUMENTS);
static void TestLoopPointwise_Int(CCTK_ARGUMENTS);
static void TestLoopPointwise_Bnd(CCTK_ARGUMENTS);
static void TestLoopPointwise_IntBnd(CCTK_ARGUMENTS);



void TestLoopPointwise_All(CCTK_ARGUMENTS)
{
...
#pragma omp parallel
  ...
  if (num_errors > 0) {
    CCTK_WARN(CCTK_WARN_ABORT, "TestLoopPointwise_All failed");
  }
}



void TestLoopPointwise_Int(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
...
#pragma omp parallel
  ...
  if (num_errors > 0) {
    CCTK_WARN(CCTK_WARN_ABORT, "TestLoopPointwise_Int failed");
  }
}



void TestLoopPointwise_Bnd(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
...
#pragma omp parallel
  ...
  if (num_errors > 0) {
    CCTK_WARN(CCTK_WARN_ABORT, "TestLoopPointwise_Bnd failed");
  }
}



void TestLoopPointwise_IntBnd(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
...
#pragma omp parallel
  ...
  if (num_errors > 0) {
    CCTK_WARN(CCTK_WARN_ABORT, "TestLoopPointwise_IntBnd failed");
  }
}



void TestLoopPointwise(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  TestLoopPointwise_All(CCTK_PASS_CTOC);
  TestLoopPointwise_Int(CCTK_PASS_CTOC);
  TestLoopPointwise_Bnd(CCTK_PASS_CTOC);
  TestLoopPointwise_IntBnd(CCTK_PASS_CTOC);
}
