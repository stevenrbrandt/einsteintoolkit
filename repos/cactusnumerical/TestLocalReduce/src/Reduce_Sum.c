...
CCTK_FILEVERSION(CactusTest_TestLocalReduce_Reduce_sum_c)

/********************************************************************
 *********************  Scheduled Routine Prototypes  ***************
 ********************************************************************/

void TestLocalReduceC_Sum(CCTK_ARGUMENTS);
...
/*@@
   @routine TestLocalReduceC_Sum
   @author     Yaakoub Y El Khamra
   @date       Tues Sep  7 16:00:29 2004
   @desc
               Tests local sum reduction
   @enddesc
...
void TestLocalReduceC_Sum(CCTK_ARGUMENTS)
{
  ...
  reduction_2D_value[0] = real_sum_2D;
  reduction_2D_value[1] = int_sum_2D;
  reduction_1D_value[0] = real_sum_1D;
  reduction_1D_value[1] = int_sum_1D;
