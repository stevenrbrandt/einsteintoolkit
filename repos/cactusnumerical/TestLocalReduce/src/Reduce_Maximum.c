...
CCTK_FILEVERSION(CactusTest_TestLocalReduce_Reduce_Maximum_c)

/********************************************************************
 *********************  Scheduled Routine Prototypes  ***************
 ********************************************************************/

void TestLocalReduceC_Maximum(CCTK_ARGUMENTS);
...
/*@@
   @routine TestLocalReduceC_Maximum
   @author     Yaakoub Y El Khamra
   @date       Tues Sep  7 16:00:29 2004
   @desc
               Tests local maximum reduction
   @enddesc
...
void TestLocalReduceC_Maximum(CCTK_ARGUMENTS)
{
  ...
  reduction_2D_value[0] = real_max_2D;
  reduction_2D_value[1] = int_max_2D;
  reduction_1D_value[0] = real_max_1D;
  reduction_1D_value[1] = int_max_1D;
