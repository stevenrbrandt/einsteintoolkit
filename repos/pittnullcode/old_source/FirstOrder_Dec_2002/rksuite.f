...
C      use prec, only rk => wp
C      contains
 
      SUBROUTINE SETUP77(NEQ,TSTART,YSTART,TEND,TOL,THRES,METHOD,TASK,
...
C     .. Common Block to hold Formula Definitions ..
      doubleprecision  A(13,13), B(13), C(13), BHAT(13), R(11,6),
     &                  E(7)
...
C     .. Common Block to hold Formula Characterisitcs ..
      doubleprecision  TOOSML, COST, SAFETY, EXPON, STBRAD, TANANG,
     &                  RS, RS1, RS2, RS3, RS4
...
C     .. Common Block for Environment Parameters ..
      doubleprecision  MCHEPS, DWARF, RNDOFF, SQRRMC, CUBRMC, TINY
      INTEGER           OUTCH
...
C     .. Parameters ..
      ...
      doubleprecision  ONE, ZERO, PT01
      PARAMETER         (ONE=1.0D+0,ZERO=0.0D+0,PT01=0.01D+0)
C     .. Local Scalars ..
      doubleprecision  HMIN
...
C  WORKSPACE
C
C     WORK(*)   - doubleprecision array as used in SETUP
...
C     .. Scalar Arguments ..
      doubleprecision  f
      doubleprecision  TGOT, TWANT
      INTEGER           UFLAG
C     .. Array Arguments ..
      doubleprecision, dimension(:) ::  WORK, YGOT, YMAX, YPGOT
...
C     .. Local Scalars ..
      doubleprecision  HMIN, TLAST, TNOW, UTEND
...
C  OUTPUT VARIABLES
C
C     RMSERR(*) - doubleprecision array of length NEQ
...
C  OUTPUT VARIABLES
C
C     TNOW      - doubleprecision
C                 Current value of the independent variable.
C     YNOW(*)   - doubleprecision array of length NEQ
C                 Approximation to the true solution at TNOW.
C     YPNOW(*)  - doubleprecision array of length NEQ
...
C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
C     .. Scalar Arguments ..
      doubleprecision  TNOW
      INTEGER           CFLAG
C     .. Array Arguments ..
      doubleprecision  WORK(*), YNOW(*), YPNOW(*)
C     .. Subroutine Arguments ..
      EXTERNAL          F
C     .. Common Block for Problem Definition ..
      doubleprecision  TSTRT, TND, DIR, HSTRT, TOLR
...
C     .. Parameters ..
      ...
      doubleprecision  ZERO, PT1, PT9, ONE, TWO, HUNDRD
      PARAMETER         (ZERO=0.0D+0,PT1=0.1D+0,PT9=0.9D+0,ONE=1.0D+0,
     &                  TWO=2.0D+0,HUNDRD=100.0D+0)
C     .. Local Scalars ..
      doubleprecision  ALPHA, BETA, ERR, ERROLD, HAVG, HMIN, HTRY, TAU,
     &                  TEMP1, TEMP2, YPNORM
...
C  OUTPUT VARIABLES
C
C     YWANT(*)  - doubleprecision array of length NWANT
C                 Approximation to the first NWANT components of the true
C                 solution at TWANT when REQESTed.
C     YPWANT(*) - doubleprecision array of length NWANT
...
C  WORKSPACE
C
C     WORK(*)   - doubleprecision array as used in SETUP and CT
C                 Do not alter the contents of this array.
C
C     WRKINT(*) - doubleprecision array of length LENINT
C                 Do not alter the contents of this array.
C
C     LENINT    - INTEGER
...
C$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
C     .. Scalar Arguments ..
      doubleprecision  TWANT
      INTEGER           LENINT, NWANT
      CHARACTER*(*)     REQEST
C     .. Array Arguments ..
      doubleprecision  WORK(*), WRKINT(*), YPWANT(*), YWANT(*)
C     .. Subroutine Arguments ..
      EXTERNAL          F
C     .. Common Block for Problem Definition ..
      doubleprecision  TSTRT, TND, DIR, HSTRT, TOLR
...
C      .. Scalar Arguments ..  
C      INTEGER           OUTCH
C      doubleprecision  DWARF, MCHEPS
C      .. External Functions ..
C      INTEGER           I1MACH
C      doubleprecision  D1MACH
C      .. Executable Statements ..
C
C      OUTCH = I1MACH(2)
C      MCHEPS = D1MACH(3)
...
C      doubleprecision  DWARF, MCHEPS
C      .. External Functions ..
C      doubleprecision  X02AJF, X02AMF
C      .. Executable Statements ..
C
...
C     .. Common Block for Environment Parameters ..
     ...
     &                  OUTCH
      SAVE   /RKCOM7/
C     .. Parameters ..
      doubleprecision  ONE, ZERO, TWO, FIFTY, FIVEPC
      PARAMETER         (ONE=1.0D+0,ZERO=0.0D+0,TWO=2.0D+0,FIFTY=50.D+0,
     &                  FIVEPC=0.05D+0)
C     .. Local Scalars ..
      doubleprecision  CDIFF, DIFF
      INTEGER           I, J
C     .. Intrinsic Functions ..
...
C     .. Scalar Arguments ..
      ...
      LOGICAL           CALSTG
C     .. Array Arguments ..
      doubleprecision  P(*), STAGES(NEQ,*), XSTAGE(*), Y(*), YOLD(*),
     &                  YP(*), YPOLD(*)
C     .. Subroutine Arguments ..
      EXTERNAL          F
C     .. Common Block to hold Problem Status ..
...
C     .. Common Block to hold Formula Definitions ..
     ...
     &                  MINTP, INTP
      SAVE   /RKCOM4/
C     .. Local Scalars ..
      doubleprecision  D1, D2, D3, D4, HYP, HYPOLD
      INTEGER           I, J, K, L
C     .. Executable Statements ..
C
      IF (METHD.EQ.1) THEN
...
C     .. Scalar Arguments ..
      ...
      CHARACTER*(*)     REQEST
C     .. Array Arguments ..
      doubleprecision  P(NWANT,*), Y(*), YP(*), YPWANT(*), YWANT(*)
C     .. Common Block to hold Problem Status ..
      doubleprecision  T, H, TOLD, HOLD
      INTEGER           NFCN, SVNFCN, OKSTP, FLSTP
      LOGICAL           FIRST, LAST
...
C     .. Scalar Arguments ..
      ...
      INTEGER           IER, NEQ
C     .. Array Arguments ..
      doubleprecision  WEIGHT(*), Y(*), ZERRES(*), ZERROR(*),
...
C     .. Common Block for Environment Parameters ..
     ...
     &                  OUTCH
      SAVE   /RKCOM7/
C     .. Parameters ..
      doubleprecision  PT1, TEN, DUMMY
      PARAMETER         (PT1=0.1D0,TEN=10.0D0,DUMMY=1.0D0)
C     .. Local Scalars ..
      doubleprecision  DIFF, ERRMAX, HMIN, HSEC, MXERLC, TSEC, ZLERR,
     &                  ZTEST1, ZTEST2
      INTEGER           ISTEP, L, LEVEL
      LOGICAL           LDUMMY, MAIN
C     .. Local Arrays ..
      doubleprecision  DUMARR(1)
C     .. External Subroutines ..
      EXTERNAL          STEP
C     .. Intrinsic Functions ..
...
C
C     .. Scalar Arguments ..
      doubleprecision  ERR, HMIN, HTRY, TNOW, TOL
      INTEGER           NEQ
      LOGICAL           MAIN, PHASE2
C     .. Array Arguments ..
      doubleprecision  ERREST(*), STAGES(NEQ,*), THRES(*), WEIGHT(*),
     &                  Y(*), YNEW(*), YP(*)
C     .. Subroutine Arguments ..
      EXTERNAL          F
C     .. Common Block for Problem Definition ..
...
C     .. Common Block for Global Error Assessment ..
     ...
     &                  PRZERS, PRZERR, PRZYNU, ERASON, ERASFL
      SAVE   /RKCOM6/
C     .. Parameters ..
      doubleprecision  ZERO, HALF, ONE
      PARAMETER         (ZERO=0.0D0,HALF=0.5D0,ONE=1.0D0)
C     .. Local Scalars ..
      doubleprecision  AVGY, TSTG
      INTEGER           I, J, L
      LOGICAL           CUTBAK
C     .. External Subroutines ..
...
C
C     .. Scalar Arguments ..
      doubleprecision  HTRY, TNOW, TSTG
      LOGICAL           CUTBAK
C     .. Array Arguments ..
      doubleprecision  WEIGHT(*), Y(*), YP(*), YPSTG(*), YSTG(*)
C     .. Common Block for Problem Definition ..
      doubleprecision  TSTRT, TND, DIR, HSTRT, TOLR
      INTEGER           NEQN
      COMMON /RKCOM1/   TSTRT, TND, DIR, HSTRT, TOLR, NEQN
...
C     .. Local Scalars ..
      doubleprecision  ARGDIF, FDIFF, SCL, TDIFF, TWT, WT, YNRM, YSTGNM
      INTEGER           L
C     .. Intrinsic Functions ..
      INTRINSIC         ABS, MAX, MIN
C     .. Executable Statements ..
...
C
C     .. Scalar Arguments ..
      doubleprecision  ERR, H
      INTEGER           NEQ
      LOGICAL           MAIN
C     .. Array Arguments ..
      doubleprecision  STAGES(NEQ,*), THRES(*), WEIGHT(*), Y(*),
     &                  YNEW(*), YP(*)
C     .. Common Block to hold Formula Definitions ..
      doubleprecision  A(13,13), B(13), C(13), BHAT(13), R(11,6),
     &                  E(7)
     ...
     &                  MINTP, INTP
      SAVE   /RKCOM4/
C     .. Parameters ..
      doubleprecision  ZERO, HALF
      PARAMETER         (ZERO=0.0D0,HALF=0.5D0)
C     .. Local Scalars ..
      doubleprecision  AVGY, SUM, WT
      INTEGER           INDEX, L
C     .. Intrinsic Functions ..
      INTRINSIC         ABS, MAX
C     .. Executable Statements ..
...
C
C     .. Scalar Arguments ..
      doubleprecision  HAVG, HNOW, X, XEND
      INTEGER           MAXFCN
      LOGICAL           STIF, UNSURE
C     .. Array Arguments ..
      doubleprecision  FXY(*), V0(*), V1(*), V2(*), V3(*), VTEMP(*),
     &                  WT(*), Y(*)
C     .. Subroutine Arguments ..
      EXTERNAL          F
C     .. Common Block for Problem Definition ..
...
C     .. Common Block for Environment Parameters ..
     ...
     &                  OUTCH
      SAVE   /RKCOM7/
C     .. Parameters ..
      doubleprecision  LARGE
      PARAMETER         (LARGE=1.0D+10)
      doubleprecision  ZERO, P001, P9, ONE, TWO, FIVE, FIFTH
      PARAMETER         (ZERO=0.0D+0,P001=0.001D+0,P9=0.9D+0,ONE=1.0D+0,
     &                  TWO=2.0D+0,FIVE=5.0D+0,FIFTH=0.2D+0)
C     .. Local Scalars ..
      doubleprecision  ALPHA1, ALPHA2, BETA1, BETA2, D1, D2, DET1,
     ...
     &                  V3NRM, V3V3, XTRFCN, YNRM
      ...
      LOGICAL           ROOTRE
C     .. Local Arrays ..
      doubleprecision  R1(2), R2(2), ROOT1(2), ROOT2(2)
C     .. External Functions ..
      doubleprecision  DOTPRD
      EXTERNAL          DOTPRD
C     .. External Subroutines ..
...
C
C     .. Scalar Arguments ..
      doubleprecision  RHO, ROLD, V0V0, V0V1, V1V1
      LOGICAL           ROOTRE
C     .. Array Arguments ..
      doubleprecision  ROOT1(2), ROOT2(2)
C     .. Parameters ..
      doubleprecision  ZERO, P001
      PARAMETER         (ZERO=0.0D+0,P001=0.001D+0)
C     .. Local Scalars ..
      doubleprecision  DET, R, RES
C     .. Intrinsic Functions ..
      INTRINSIC         ABS
C     .. Executable Statements ..
C
...
C     .. Array Arguments ..
      doubleprecision  R1(2), R2(2)
C     .. Parameters ..
      doubleprecision  ZERO, TWO
      PARAMETER         (ZERO=0.0D+0,TWO=2.0D+0)
C     .. Local Scalars ..
      doubleprecision  DISC, SQDISC, TEMP
C     .. Intrinsic Functions ..
      INTRINSIC         ABS, SQRT
C     .. Executable Statements ..
      TEMP = ALPHA/TWO
...
C  doubleprecision FUNCTION DOTPRD(U,V,WT,NEQ) to compute the dot (inner)
C  product.  The vector VTEMP(*) is used for working storage.
C
C     .. Scalar Arguments ..
      doubleprecision  HAVG, SCALE, VDOTV, X, ZDOTZ
C     .. Array Arguments ..
      doubleprecision  FXY(*), V(*), VTEMP(*), WT(*), Y(*), Z(*)
C     .. Subroutine Arguments ..
      EXTERNAL          F
C     .. Common Block for Problem Definition ..
      doubleprecision  TSTRT, TND, DIR, HSTRT, TOLR
...
C
      RETURN
      END
      doubleprecision  FUNCTION DOTPRD(U,V,WT,NEQ)
C************************************************
C**** NOT A DESIGNATED USER-CALLABLE ROUTINE ****
C************************************************
C
