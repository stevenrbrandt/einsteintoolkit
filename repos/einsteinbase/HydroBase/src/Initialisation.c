...
void HydroBase_Zero(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_HydroBase_Zero;
...
void HydroBase_Y_e_one(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_HydroBase_Y_e_one;
  DECLARE_CCTK_PARAMETERS;
...
void HydroBase_Bvec_zero(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_HydroBase_Bvec_zero;
  DECLARE_CCTK_PARAMETERS;
...
void HydroBase_Avec_zero(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_HydroBase_Avec_zero;
  DECLARE_CCTK_PARAMETERS;
...
void HydroBase_Aphi_zero(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_HydroBase_Aphi_zero;
  DECLARE_CCTK_PARAMETERS;
...
void HydroBase_InitExcisionMask(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_HydroBase_InitExcisionMask;
  DECLARE_CCTK_PARAMETERS;
