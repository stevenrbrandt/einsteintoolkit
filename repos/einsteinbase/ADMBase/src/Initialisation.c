...
/*@@
 ...
 @@*/
void ADMBase_CartesianMinkowski(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_CartesianMinkowski;
...
/*@@
 ...
 @@*/
void ADMBase_LapseOne(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_LapseOne;
  DECLARE_CCTK_PARAMETERS;
...
/*@@
 ...
 @@*/
void ADMBase_ShiftZero(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_ShiftZero;
  DECLARE_CCTK_PARAMETERS;
...
/*@@
 ...
 @@*/
void ADMBase_DtLapseZero(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_DtLapseZero;
  DECLARE_CCTK_PARAMETERS;
...
/*@@
 ...
 @@*/
void ADMBase_DtShiftZero(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_DtShiftZero;
  DECLARE_CCTK_PARAMETERS;
...
/*@@
 ...
 @@*/
void ADMBase_SetShiftStateOn(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_SetShiftStateOn;
  DECLARE_CCTK_PARAMETERS;
...
/*@@
 ...
 @@*/
void ADMBase_SetShiftStateOff(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_SetShiftStateOff;
  DECLARE_CCTK_PARAMETERS;
...
/*@@
 ...
 @@*/
void ADMBase_SetDtLapseStateOn(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_SetDtLapseStateOn;
  DECLARE_CCTK_PARAMETERS;
...
/*@@
 ...
 @@*/
void ADMBase_SetDtLapseStateOff(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_SetDtLapseStateOff;
  DECLARE_CCTK_PARAMETERS;
...
/*@@
 ...
 @@*/
void ADMBase_SetDtShiftStateOn(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_SetDtShiftStateOn;
  DECLARE_CCTK_PARAMETERS;
...
/*@@
 ...
 @@*/
void ADMBase_SetDtShiftStateOff(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_ADMBase_SetDtShiftStateOff;
  DECLARE_CCTK_PARAMETERS;
