...
extern "C" void GiRaFFE_compute_B_and_Bstagger_from_A(CCTK_ARGUMENTS) {
  ...
  LOOP_DEFINE_SIMPLE {
    ...
    const CCTK_REAL Psi = psi_bssn[actual_index];
    const CCTK_REAL Psim3 = 1.0/(Psi*Psi*Psi);
    ...
    const CCTK_REAL Psi_ip1 = psi_bssn[indexip1jk];
    ...
    const CCTK_REAL Psi_jp1 = psi_bssn[indexijp1k];
    ...
    const CCTK_REAL Psi_kp1 = psi_bssn[indexijkp1];
  ...
  GiRaFFE_set_symmetry_gzs_staggered(cctkGH,cctk_lsh,x,y,z,  By        , gridfunc_syms_By,0,0,0);
