...
#define vec4_architecture                                                      \
  "SSE" vec4_architecture_SSE4_1 vec4_architecture_SSE4a                       \
      vec4_architecture_FMA4 " (32-bit precision)"
...
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_swap1032(CCTK_REAL4_VEC const x) {
  return _mm_shuffle_ps(x, x, _MM_SHUFFLE(2, 3, 0, 1));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_swap2301(CCTK_REAL4_VEC const x) {
  return _mm_shuffle_ps(x, x, _MM_SHUFFLE(1, 0, 3, 2));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_swap3210(CCTK_REAL4_VEC const x) {
...
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_load_off1(CCTK_REAL4 const &p) {
  return vec4_loadu(p);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_load_off2(CCTK_REAL4 const &p) {
  return vec4_loadu(p);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_load_off3(CCTK_REAL4 const &p) {
  return vec4_loadu(p);
}
#else
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
...
k4copysign(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return _mm_or_ps(_mm_and_ps(I2R(k4notsign), x), _mm_and_ps(I2R(k4sign), y));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
...
#elif 0
  return vec4_set(
      std::signbit(vec4_elt(x, 0)) ? vec4_elt(y, 0) : vec4_elt(z, 0),
