...
// Functions
#define k8acos(x) (std::acos(x))
#define k8acosh(x) (std::acosh(x))
#define k8asin(x) (std::asin(x))
#define k8asinh(x) (std::asinh(x))
#define k8atan(x) (std::atan(x))
#define k8atan2(x, y) (std::atan2(x, y))
#define k8atanh(x) (std::atanh(x))
#define k8copysign(x, y) (std::copysign(x, y))
#define k8cos(x) (std::cos(x))
#define k8cosh(x) (std::cosh(x))
#define k8exp(x) (std::exp(x))
#define k8fabs(x) (std::fabs(x))
#define k8fmax(x, y) (std::fmax(x, y))
#define k8fmin(x, y) (std::fmin(x, y))
#define k8fmod(x, y) (std::fmod(x, y))
#define k8fnabs(x) (-std::fabs(x))
#define k8log(x) (std::log(x))
#define k8pow(x, a) (std::pow(x, a))
#define k8pown(x, a) (std::pow(x, a))
#define k8sin(x) (std::sin(x))
#define k8sinh(x) (std::sinh(x))
#define k8sqrt(x) (std::sqrt(x))
#define k8tan(x) (std::tan(x))
#define k8tanh(x) (std::tanh(x))
