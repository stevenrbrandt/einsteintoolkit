...
vec4_set1(CCTK_REAL4 const a) {
  return _mm256_set1_ps(a);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_INTEGER4_VEC
vec4_set1i(CCTK_INT4 const a) {
  return _mm256_set1_epi32(a);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_set(CCTK_REAL4 const a, CCTK_REAL4 const b, CCTK_REAL4 const c,
         CCTK_REAL4 const d, CCTK_REAL4 const e, CCTK_REAL4 const f,
...
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_load(CCTK_REAL4 const &p) {
  return _mm256_load_ps(&p);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_loadu(CCTK_REAL4 const &p) {
...
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_loadu_maybe(std::ptrdiff_t const off, CCTK_REAL4 const &p) {
  return vec4_loadu(p);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
vec4_loadu_maybe3(std::ptrdiff_t const off1, std::ptrdiff_t const off2,
                  std::ptrdiff_t const off3, CCTK_REAL4 const &p) {
  return vec4_loadu(p);
}
#else
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
...
vec4_loadu_maybe3(std::ptrdiff_t const off1, std::ptrdiff_t const off2,
                  std::ptrdiff_t const off3, CCTK_REAL4 const &p) {
  return off2 % CCTK_REAL4_VEC_SIZE != 0 or off3 % CCTK_REAL4_VEC_SIZE != 0
             ? vec4_loadu(p)
...
vec4_store(CCTK_REAL4 &p, CCTK_REAL4_VEC const x) {
  return _mm256_store_ps(&p, x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE void
vec4_storeu(CCTK_REAL4 &p, CCTK_REAL4_VEC const x) {
  return _mm256_storeu_ps(&p, x);
}
#if !VECTORISE_STREAMING_STORES
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE void
vec4_store_nta(CCTK_REAL4 &p, CCTK_REAL4_VEC const x) {
...
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE void
vec4_store_partial_prepare_(bool &all, __m256i &mask, std::ptrdiff_t const i,
...
#define vec4_storeu_partial(p, x)                                              \
  vec4_storeu_partial_(v4stp_all, v4stp_mask, p, x)
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE void
...
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE void
vec4_store_nta_partial_lo(CCTK_REAL4 &p, CCTK_REAL4_VEC const x,
                          ptrdiff_t const n) {
...
vec4_store_nta_partial_mid(CCTK_REAL4 &p, CCTK_REAL4_VEC const x,
                           ptrdiff_t const nlo, ptrdiff_t const nhi) {
  _mm256_maskstore_ps(
      &p, R2I(_mm256_and_ps(I2R(k4store_lo[nlo].vi), I2R(k4store_hi[nhi].vi))),
      x);
}
#endif
...
// Operators
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4neg(CCTK_REAL4_VEC const x) {
  return _mm256_xor_ps(x, I2R(k4sign));
}

static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4add(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return _mm256_add_ps(x, y);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4sub(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return _mm256_sub_ps(x, y);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4mul(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return _mm256_mul_ps(x, y);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4div(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
...
#ifdef __FMA4__
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4madd(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y, CCTK_REAL4_VEC const z) {
  return _mm256_macc_ps(x, y, z);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4msub(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y, CCTK_REAL4_VEC const z) {
  return _mm256_msub_ps(x, y, z);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC k4nmadd(
    CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y, CCTK_REAL4_VEC const z) {
  return _mm256_nmsub_ps(x, y, z);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC k4nmsub(
    CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y, CCTK_REAL4_VEC const z) {
...
// Cheap functions
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4copysign(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return _mm256_or_ps(_mm256_and_ps(I2R(k4notsign), x),
                      _mm256_and_ps(I2R(k4sign), y));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4fabs(CCTK_REAL4_VEC const x) {
  return _mm256_and_ps(I2R(k4notsign), x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4fmax(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return _mm256_max_ps(x, y);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4fmin(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return _mm256_min_ps(x, y);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4fnabs(CCTK_REAL4_VEC const x) {
...
#define K4REPL(f, x)                                                           \
  vec4_set(f(vec4_elt(x, 0)), f(vec4_elt(x, 1)), f(vec4_elt(x, 2)),            \
           f(vec4_elt(x, 3)), f(vec4_elt(x, 4)), f(vec4_elt(x, 5)),            \
           f(vec4_elt(x, 6)), f(vec4_elt(x, 7)));
#define K4REPL2S(f, x, a)                                                      \
  vec4_set(f(vec4_elt(x, 0), a), f(vec4_elt(x, 1), a), f(vec4_elt(x, 2), a),   \
           f(vec4_elt(x, 3), a), f(vec4_elt(x, 4), a), f(vec4_elt(x, 5), a),   \
           f(vec4_elt(x, 6), a), f(vec4_elt(x, 7), a));
#define K4REPL2(f, x, y)                                                       \
  vec4_set(                                                                    \
      f(vec4_elt(x, 0), vec4_elt(y, 0)), f(vec4_elt(x, 1), vec4_elt(y, 1)),    \
      f(vec4_elt(x, 2), vec4_elt(y, 2)), f(vec4_elt(x, 3), vec4_elt(y, 3)),    \
      f(vec4_elt(x, 4), vec4_elt(y, 4)), f(vec4_elt(x, 5), vec4_elt(y, 5)),    \
      f(vec4_elt(x, 6), vec4_elt(y, 6)), f(vec4_elt(x, 7), vec4_elt(y, 7)));

#if defined __ICC
// The Intel compiler provides intrinsics for these

static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4acos(CCTK_REAL4_VEC const x) {
  return _mm256_acos_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4acosh(CCTK_REAL4_VEC const x) {
  return _mm256_acosh_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4asin(CCTK_REAL4_VEC const x) {
  return _mm256_asin_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4asinh(CCTK_REAL4_VEC const x) {
  return _mm256_asinh_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4atan(CCTK_REAL4_VEC const x) {
  return _mm256_atan_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4atan2(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return _mm256_atan2_ps(x, y);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4atanh(CCTK_REAL4_VEC const x) {
  return _mm256_atanh_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4cos(CCTK_REAL4_VEC const x) {
  return _mm256_cos_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4cosh(CCTK_REAL4_VEC const x) {
  return _mm256_cosh_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4exp(CCTK_REAL4_VEC const x) {
  return _mm256_exp_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4fmod(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
#if __ICC > 1400
...
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4sinh(CCTK_REAL4_VEC const x) {
  return _mm256_sinh_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4tan(CCTK_REAL4_VEC const x) {
  return _mm256_tan_ps(x);
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4tanh(CCTK_REAL4_VEC const x) {
...
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_BOOLEAN4_VEC
k4lnot(CCTK_BOOLEAN4_VEC const x) {
  return R2I(_mm256_xor_ps(I2R(k4ltrue), I2R(x)));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_BOOLEAN4_VEC
k4land(CCTK_BOOLEAN4_VEC const x, CCTK_BOOLEAN4_VEC const y) {
  return R2I(_mm256_and_ps(I2R(x), I2R(y)));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_BOOLEAN4_VEC
k4lor(CCTK_BOOLEAN4_VEC const x, CCTK_BOOLEAN4_VEC const y) {
  return R2I(_mm256_or_ps(I2R(x), I2R(y)));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_BOOLEAN4_VEC
k4lxor(CCTK_BOOLEAN4_VEC const x, CCTK_BOOLEAN4_VEC const y) {
  return R2I(_mm256_xor_ps(I2R(x), I2R(y)));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC k4ifthen(
    CCTK_BOOLEAN4_VEC const x, CCTK_REAL4_VEC const y, CCTK_REAL4_VEC const z) {
  return _mm256_blendv_ps(z, y, I2R(x));
}

static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_BOOLEAN4_VEC
k4cmpeq(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return R2I(_mm256_cmp_ps(x, y, _CMP_EQ_OQ));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_BOOLEAN4_VEC
k4cmpne(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return R2I(_mm256_cmp_ps(x, y, _CMP_NEQ_UQ));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_BOOLEAN4_VEC
k4cmpgt(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return R2I(_mm256_cmp_ps(x, y, _CMP_GT_OQ));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_BOOLEAN4_VEC
k4cmpge(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return R2I(_mm256_cmp_ps(x, y, _CMP_GE_OQ));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_BOOLEAN4_VEC
k4cmplt(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return R2I(_mm256_cmp_ps(x, y, _CMP_LT_OQ));
}
static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_BOOLEAN4_VEC
k4cmple(CCTK_REAL4_VEC const x, CCTK_REAL4_VEC const y) {
  return R2I(_mm256_cmp_ps(x, y, _CMP_LE_OQ));
}

static inline CCTK_ATTRIBUTE_ALWAYS_INLINE CCTK_REAL4_VEC
k4sgn(CCTK_REAL4_VEC const x) {
