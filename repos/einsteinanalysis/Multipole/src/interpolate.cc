...
void Multipole_Interp(CCTK_ARGUMENTS,
                      vector<CCTK_REAL> const &xs, vector<CCTK_REAL> const &ys,
                      vector<CCTK_REAL> const &zs,
                      int real_idx, int imag_idx,
                      vector<CCTK_REAL> &sphere_real, vector<CCTK_REAL> &sphere_imag)
{
