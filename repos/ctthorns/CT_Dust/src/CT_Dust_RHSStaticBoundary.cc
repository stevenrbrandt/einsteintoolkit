...
extern "C" void CT_Dust_RHSStaticBoundary_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % CT_Dust_RHSStaticBoundary_calc_every != CT_Dust_RHSStaticBoundary_calc_offset)
    return;
...
static void CT_Dust_RHSStaticBoundary_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(CT_Dust_RHSStaticBoundary,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL EErhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL SS1rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL SS2rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL SS3rhsL CCTK_ATTRIBUTE_UNUSED = 0;
    /* Copy local copies back to grid functions */
    DDrhs[index] = DDrhsL;
    EErhs[index] = EErhsL;
  ...
  CCTK_ENDLOOP3(CT_Dust_RHSStaticBoundary);
}
extern "C" void CT_Dust_RHSStaticBoundary(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CT_Dust_RHSStaticBoundary_Body");
  }
  if (cctk_iteration % CT_Dust_RHSStaticBoundary_calc_every != CT_Dust_RHSStaticBoundary_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "CT_Dust::CT_Erhs",
    "CT_Dust::CT_Srhs"};
  AssertGroupStorage(cctkGH, "CT_Dust_RHSStaticBoundary", 3, groups);
  ...
  LoopOverBoundary(cctkGH, CT_Dust_RHSStaticBoundary_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CT_Dust_RHSStaticBoundary_Body");
  }
}
