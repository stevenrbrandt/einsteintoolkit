...
static void CT_Dust_convertFromPrimitives_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(CT_Dust_convertFromPrimitives,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL h CCTK_ATTRIBUTE_UNUSED = 1 + epsL + w;
    
    WL = u0*pow(-det4g,0.5);
    
    CCTK_REAL DDL CCTK_ATTRIBUTE_UNUSED = rhoL*WL;
    
    CCTK_REAL EEL CCTK_ATTRIBUTE_UNUSED = epsL*rhoL*WL;
    
    CCTK_REAL SS1L CCTK_ATTRIBUTE_UNUSED = rhoL*u1L*WL*h;
    
    CCTK_REAL SS2L CCTK_ATTRIBUTE_UNUSED = rhoL*u2L*WL*h;
    
    CCTK_REAL SS3L CCTK_ATTRIBUTE_UNUSED = rhoL*u3L*WL*h;
    
    CCTK_REAL V1L CCTK_ATTRIBUTE_UNUSED = (u1L*gu11 + u2L*gu12 + 
      u3L*gu13)*u0;
    
    CCTK_REAL V2L CCTK_ATTRIBUTE_UNUSED = (u1L*gu12 + u2L*gu22 + 
      u3L*gu23)*u0;
    
    CCTK_REAL V3L CCTK_ATTRIBUTE_UNUSED = (u1L*gu13 + u2L*gu23 + 
      u3L*gu33)*u0;
    /* Copy local copies back to grid functions */
    DD[index] = DDL;
    EE[index] = EEL;
  ...
  CCTK_ENDLOOP3(CT_Dust_convertFromPrimitives);
}
extern "C" void CT_Dust_convertFromPrimitives(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CT_Dust_convertFromPrimitives_Body");
  }
  if (cctk_iteration % CT_Dust_convertFromPrimitives_calc_every != CT_Dust_convertFromPrimitives_calc_offset)
  {
    return;
  }
  ...
  const char* const groups[] = {
    ...
    "CT_Dust::CT_V",
    "CT_Dust::CT_W"};
  AssertGroupStorage(cctkGH, "CT_Dust_convertFromPrimitives", 11, groups);
  ...
  LoopOverEverything(cctkGH, CT_Dust_convertFromPrimitives_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CT_Dust_convertFromPrimitives_Body");
  }
}
