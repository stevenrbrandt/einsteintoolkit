...
extern "C" void CT_Dust_setCTTrhs_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % CT_Dust_setCTTrhs_calc_every != CT_Dust_setCTTrhs_calc_offset)
    return;
  CCTK_INT ierr CCTK_ATTRIBUTE_UNUSED = 0;
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "CT_Dust::CT_cttS","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for CT_Dust::CT_cttS.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "CT_Dust::CT_cttV","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for CT_Dust::CT_cttV.");
  return;
}

static void CT_Dust_setCTTrhs_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL u0u CCTK_ATTRIBUTE_UNUSED = 0.5*(f1 + pow(4*f2 + 
      pow(f1,2),0.5));
    
    CCTK_REAL bsq CCTK_ATTRIBUTE_UNUSED = 2*(betaxL*(betayL*gxyL + 
      betazL*gxzL) + betayL*betazL*gyzL) + gxxL*pow(betaxL,2) + 
      gyyL*pow(betayL,2) + gzzL*pow(betazL,2);
    
    CCTK_REAL u0l CCTK_ATTRIBUTE_UNUSED = betaxL*u1L + betayL*u2L + 
      betazL*u3L + u0u*(bsq - pow(alpL,2));
    
    CCTK_REAL t00 CCTK_ATTRIBUTE_UNUSED = (prsL - 
      0.0397887357729738339422209408431*Lambda)*(bsq - pow(alpL,2)) + (prsL + 
      rhoL)*pow(u0l,2);
    
    CCTK_REAL t01 CCTK_ATTRIBUTE_UNUSED = (betaxL*gxxL + betayL*gxyL + 
      betazL*gxzL)*(prsL - 0.0397887357729738339422209408431*Lambda) + (prsL 
      + rhoL)*u1L*u0l;
    
    CCTK_REAL t02 CCTK_ATTRIBUTE_UNUSED = (betaxL*gxyL + betayL*gyyL + 
      betazL*gyzL)*(prsL - 0.0397887357729738339422209408431*Lambda) + (prsL 
      + rhoL)*u2L*u0l;
    
    CCTK_REAL t03 CCTK_ATTRIBUTE_UNUSED = (betaxL*gxzL + betayL*gyzL + 
      betazL*gzzL)*(prsL - 0.0397887357729738339422209408431*Lambda) + (prsL 
      + rhoL)*u3L*u0l;
    
    CCTK_REAL t11 CCTK_ATTRIBUTE_UNUSED = gxxL*(prsL - 
      0.0397887357729738339422209408431*Lambda) + (prsL + rhoL)*pow(u1L,2);
    
    CCTK_REAL t12 CCTK_ATTRIBUTE_UNUSED = (prsL + rhoL)*u1L*u2L + 
      gxyL*(prsL - 0.0397887357729738339422209408431*Lambda);
    
    CCTK_REAL t13 CCTK_ATTRIBUTE_UNUSED = (prsL + rhoL)*u1L*u3L + 
      gxzL*(prsL - 0.0397887357729738339422209408431*Lambda);
    
    CCTK_REAL t21 CCTK_ATTRIBUTE_UNUSED = (prsL + rhoL)*u1L*u2L + 
      gxyL*(prsL - 0.0397887357729738339422209408431*Lambda);
    
    CCTK_REAL t22 CCTK_ATTRIBUTE_UNUSED = gyyL*(prsL - 
      0.0397887357729738339422209408431*Lambda) + (prsL + rhoL)*pow(u2L,2);
    
    CCTK_REAL t23 CCTK_ATTRIBUTE_UNUSED = (prsL + rhoL)*u2L*u3L + 
      gyzL*(prsL - 0.0397887357729738339422209408431*Lambda);
    
    CCTK_REAL t31 CCTK_ATTRIBUTE_UNUSED = (prsL + rhoL)*u1L*u3L + 
      gxzL*(prsL - 0.0397887357729738339422209408431*Lambda);
    
    CCTK_REAL t32 CCTK_ATTRIBUTE_UNUSED = (prsL + rhoL)*u2L*u3L + 
      gyzL*(prsL - 0.0397887357729738339422209408431*Lambda);
    
    CCTK_REAL t33 CCTK_ATTRIBUTE_UNUSED = gzzL*(prsL - 
      0.0397887357729738339422209408431*Lambda) + (prsL + rhoL)*pow(u3L,2);
    
    CCTK_REAL cttSL CCTK_ATTRIBUTE_UNUSED = 
      6.283185307179586476925286766559005768394*(t00 - 2*(betaxL*t01 + 
      betayL*t02 + betazL*t03) + betaxL*(betaxL*t11 + betayL*t21 + 
      betazL*t31) + betayL*(betaxL*t12 + betayL*t22 + betazL*t32) + 
      betazL*(betaxL*t13 + betayL*t23 + betazL*t33))*pow(alpL,-2);
    
    CCTK_REAL cttV1L CCTK_ATTRIBUTE_UNUSED = 
      25.13274122871834590770114706623602307358*(t01 - betaxL*t11 - 
      betayL*t21 - betazL*t31)*pow(alpL,-1);
    
    CCTK_REAL cttV2L CCTK_ATTRIBUTE_UNUSED = 
      25.13274122871834590770114706623602307358*(t02 - betaxL*t12 - 
      betayL*t22 - betazL*t32)*pow(alpL,-1);
    
    CCTK_REAL cttV3L CCTK_ATTRIBUTE_UNUSED = 
      25.13274122871834590770114706623602307358*(t03 - betaxL*t13 - 
      betayL*t23 - betazL*t33)*pow(alpL,-1);
    /* Copy local copies back to grid functions */
    cttS[index] = cttSL;
    cttV1[index] = cttV1L;
    cttV2[index] = cttV2L;
  ...
  CCTK_ENDLOOP3(CT_Dust_setCTTrhs);
}
extern "C" void CT_Dust_setCTTrhs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CT_Dust_setCTTrhs_Body");
  }
  if (cctk_iteration % CT_Dust_setCTTrhs_calc_every != CT_Dust_setCTTrhs_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "CT_Dust::CT_rho",
    "CT_Dust::CT_u"};
  AssertGroupStorage(cctkGH, "CT_Dust_setCTTrhs", 8, groups);
  ...
  LoopOverInterior(cctkGH, CT_Dust_setCTTrhs_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CT_Dust_setCTTrhs_Body");
  }
}
