...
static void CT_Dust_MB_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL kxyL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL kxzL CCTK_ATTRIBUTE_UNUSED = 0;
    ...
    CCTK_REAL kyzL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL kzzL CCTK_ATTRIBUTE_UNUSED = 
      -0.00555555555555555555555555555556*pow(-1 + 
    ...
    CCTK_REAL alpL CCTK_ATTRIBUTE_UNUSED = 1;
    
    CCTK_REAL betaxL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL betayL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL betazL CCTK_ATTRIBUTE_UNUSED = 0;
  ...
  CCTK_ENDLOOP3(CT_Dust_MB);
}
extern "C" void CT_Dust_MB(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CT_Dust_MB_Body");
  }
  if (cctk_iteration % CT_Dust_MB_calc_every != CT_Dust_MB_calc_offset)
  {
    return;
  }
  ...
  const char* const groups[] = {
    ...
    "CT_Dust::CT_u",
    "grid::coordinates"};
  AssertGroupStorage(cctkGH, "CT_Dust_MB", 10, groups);
  ...
  LoopOverEverything(cctkGH, CT_Dust_MB_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CT_Dust_MB_Body");
  }
}
