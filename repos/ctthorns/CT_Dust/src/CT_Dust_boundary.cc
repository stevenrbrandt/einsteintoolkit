...
extern "C" void CT_Dust_boundary_SelectBCs(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % CT_Dust_boundary_calc_every != CT_Dust_boundary_calc_offset)
    return;
  CCTK_INT ierr CCTK_ATTRIBUTE_UNUSED = 0;
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "CT_Dust::CT_D","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for CT_Dust::CT_D.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "CT_Dust::CT_E","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for CT_Dust::CT_E.");
  ierr = Boundary_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "CT_Dust::CT_S","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for CT_Dust::CT_S.");
  return;
}

static void CT_Dust_boundary_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL DDL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL EEL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL SS1L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL SS2L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL SS3L CCTK_ATTRIBUTE_UNUSED = 0;
    /* Copy local copies back to grid functions */
    DD[index] = DDL;
    EE[index] = EEL;
    SS1[index] = SS1L;
  ...
  CCTK_ENDLOOP3(CT_Dust_boundary);
}
extern "C" void CT_Dust_boundary(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CT_Dust_boundary_Body");
  }
  if (cctk_iteration % CT_Dust_boundary_calc_every != CT_Dust_boundary_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "CT_Dust::CT_E",
    "CT_Dust::CT_S"};
  AssertGroupStorage(cctkGH, "CT_Dust_boundary", 3, groups);
  ...
  LoopOverBoundaryWithGhosts(cctkGH, CT_Dust_boundary_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CT_Dust_boundary_Body");
  }
}
