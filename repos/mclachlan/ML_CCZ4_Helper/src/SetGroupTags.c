...
int ML_CCZ4_SetGroupTags(void) {
  ...
  set_group_tags(other_global, other_global, other_global, "ML_CCZ4::ML_Ham");
  set_group_tags(other_global, other_global, other_global, "ML_CCZ4::ML_mom");

  // RHS variables do not have valid boundaries
  bool rhs_global = rhs_timelevels > 1;
  set_group_tags(rhs_global, rhs_global, false, "ML_CCZ4::ML_log_confacrhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_CCZ4::ML_metricrhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_CCZ4::ML_Gammarhs");

#ifdef HAVE_THETA
  set_group_tags(rhs_global, rhs_global, false, "ML_CCZ4::ML_Thetarhs");
#endif
  set_group_tags(rhs_global, rhs_global, false, "ML_CCZ4::ML_trace_curvrhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_CCZ4::ML_curvrhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_CCZ4::ML_lapserhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_CCZ4::ML_dtlapserhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_CCZ4::ML_shiftrhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_CCZ4::ML_dtshiftrhs");
