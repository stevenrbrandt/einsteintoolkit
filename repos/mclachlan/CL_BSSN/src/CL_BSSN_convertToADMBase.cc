...
static void CL_BSSN_convertToADMBase_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3STR(CL_BSSN_convertToADMBase,
    ...
    vecimin,vecimax, CCTK_REAL_VEC_SIZE)
  {
    ...
    CCTK_REAL_VEC kxxL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(0.333333333333333333333333333333),kmul(gxxL,trKL),kmul(At11L,e4phi));
    
    CCTK_REAL_VEC kxyL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(0.333333333333333333333333333333),kmul(gxyL,trKL),kmul(At12L,e4phi));
    
    CCTK_REAL_VEC kxzL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(0.333333333333333333333333333333),kmul(gxzL,trKL),kmul(At13L,e4phi));
    
    CCTK_REAL_VEC kyyL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(0.333333333333333333333333333333),kmul(gyyL,trKL),kmul(At22L,e4phi));
    
    CCTK_REAL_VEC kyzL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(0.333333333333333333333333333333),kmul(gyzL,trKL),kmul(At23L,e4phi));
    
    CCTK_REAL_VEC kzzL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(0.333333333333333333333333333333),kmul(gzzL,trKL),kmul(At33L,e4phi));
  ...
  CCTK_ENDLOOP3STR(CL_BSSN_convertToADMBase);
}
extern "C" void CL_BSSN_convertToADMBase(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CL_BSSN_convertToADMBase
  DECLARE_CCTK_ARGUMENTS_CHECKED(CL_BSSN_convertToADMBase);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CL_BSSN_convertToADMBase_Body");
  }
  if (cctk_iteration % CL_BSSN_convertToADMBase_calc_every != CL_BSSN_convertToADMBase_calc_offset)
  {
    return;
  }
  ...
  AssertGroupStorage(cctkGH, "CL_BSSN_convertToADMBase", 10, groups);
  ...
  LoopOverEverything(cctkGH, CL_BSSN_convertToADMBase_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CL_BSSN_convertToADMBase_Body");
  }
}
