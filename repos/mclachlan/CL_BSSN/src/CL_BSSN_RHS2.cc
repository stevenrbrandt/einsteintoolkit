...
extern "C" void CL_BSSN_RHS2_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CL_BSSN_RHS2_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(CL_BSSN_RHS2_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % CL_BSSN_RHS2_calc_every != CL_BSSN_RHS2_calc_offset)
    return;
  CCTK_INT ierr CCTK_ATTRIBUTE_UNUSED = 0;
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "CL_BSSN::CL_curvrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for CL_BSSN::CL_curvrhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "CL_BSSN::CL_trace_curvrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for CL_BSSN::CL_trace_curvrhs.");
  return;
}

static void CL_BSSN_RHS2_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
    ...
    vecimin,vecimax, CCTK_REAL_VEC_SIZE)
  {
    ...
    CCTK_REAL_VEC gu21 CCTK_ATTRIBUTE_UNUSED = kmul(em4phi,gtu21);
    
    CCTK_REAL_VEC gu31 CCTK_ATTRIBUTE_UNUSED = kmul(em4phi,gtu31);
    
    CCTK_REAL_VEC gu22 CCTK_ATTRIBUTE_UNUSED = kmul(em4phi,gtu22);
    
    CCTK_REAL_VEC gu32 CCTK_ATTRIBUTE_UNUSED = kmul(em4phi,gtu32);
    ...
    CCTK_REAL_VEC trS CCTK_ATTRIBUTE_UNUSED = 
      kmadd(eTxxL,gu11,kmadd(eTyyL,gu22,kmadd(ToReal(2),kmadd(eTxyL,gu21,kmadd(eTxzL,gu31,kmul(eTyzL,gu32))),kmul(eTzzL,gu33))));
    
    CCTK_REAL_VEC trKrhsL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(-0.166666666666666666666666666667),kmul(em4phi,kmadd(dalpha1L,kmadd(kmadd(ToReal(-6),Gt111,dphi1L),gtu11,kmadd(kmadd(ToReal(-12),Gt112,dphi2L),gtu21,kmadd(kmadd(ToReal(-12),Gt113,dphi3L),gtu31,kmadd(ToReal(-12),kmul(Gt123,gtu32),kmul(kmadd(Gt122,gtu22,kmul(Gt133,gtu33)),ToReal(-6)))))),kmadd(dalpha2L,kmadd(kmadd(ToReal(-12),Gt212,dphi1L),gtu21,kmadd(dphi2L,gtu22,kmadd(dphi3L,gtu32,kmadd(ToReal(-12),kmadd(Gt213,gtu31,kmul(Gt223,gtu32)),kmul(kmadd(Gt211,gtu11,kmadd(Gt222,gtu22,kmul(Gt233,gtu33))),ToReal(-6)))))),kmadd(dalpha3L,kmadd(dphi1L,gtu31,kmadd(dphi2L,gtu32,kmadd(ToReal(-12),kmadd(Gt312,gtu21,kmadd(Gt313,gtu31,kmul(Gt323,gtu32))),kmadd(dphi3L,gtu33,kmul(kmadd(Gt311,gtu11,kmadd(Gt322,gtu22,kmul(Gt333,gtu33))),ToReal(-6)))))),kmul(kmadd(gtu11,JacPDstandardNth1dalpha1,kmadd(gtu21,kadd(JacPDstandardNth1dalpha2,JacPDstandardNth2dalpha1),kmadd(gtu22,JacPDstandardNth2dalpha2,kmadd(gtu31,kadd(JacPDstandardNth1dalpha3,JacPDstandardNth3dalpha1),kmadd(gtu32,kadd(JacPDstandardNth2dalpha3,JacPDstandardNth3dalpha2),kmul(gtu33,JacPDstandardNth3dalpha3)))))),ToReal(6)))))),kmadd(beta1L,JacPDupwindNthAnti1trK,kmadd(beta2L,JacPDupwindNthAnti2trK,kmadd(beta3L,JacPDupwindNthAnti3trK,kmadd(JacPDupwindNthSymm1trK,kfabs(beta1L),kmadd(JacPDupwindNthSymm2trK,kfabs(beta2L),kmadd(JacPDupwindNthSymm3trK,kfabs(beta3L),kmul(alphaL,kmadd(At11L,Atu11,kmadd(At22L,Atu22,kmadd(ToReal(2),kmadd(At12L,Atu21,kmadd(At13L,Atu31,kmul(At23L,Atu32))),kmadd(At33L,Atu33,kmadd(ToReal(12.56637061435917295385057353311801153679),kadd(rho,trS),kmul(kmul(trKL,trKL),ToReal(0.333333333333333333333333333333)))))))))))))));
    
    CCTK_REAL_VEC Ats11 CCTK_ATTRIBUTE_UNUSED = 
      kmadd(dalpha1L,kmadd(ToReal(0.333333333333333333333333333333),dphi1L,Gt111),kmadd(dalpha2L,Gt211,kmadd(dalpha3L,Gt311,kmsub(alphaL,R11,JacPDstandardNth1dalpha1))));
    
    CCTK_REAL_VEC Ats12 CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(0.166666666666666666666666666667),kmadd(dalpha2L,dphi1L,kmul(dalpha1L,dphi2L)),kmadd(dalpha1L,Gt112,kmadd(dalpha2L,Gt212,kmadd(dalpha3L,Gt312,kmsub(alphaL,R12,JacPDstandardNth1dalpha2)))));
    
    CCTK_REAL_VEC Ats13 CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(0.166666666666666666666666666667),kmadd(dalpha3L,dphi1L,kmul(dalpha1L,dphi3L)),kmadd(dalpha1L,Gt113,kmadd(dalpha2L,Gt213,kmadd(dalpha3L,Gt313,kmsub(alphaL,R13,JacPDstandardNth1dalpha3)))));
    
    CCTK_REAL_VEC Ats22 CCTK_ATTRIBUTE_UNUSED = 
      kmadd(dalpha1L,Gt122,kmadd(dalpha2L,kmadd(ToReal(0.333333333333333333333333333333),dphi2L,Gt222),kmadd(dalpha3L,Gt322,kmsub(alphaL,R22,JacPDstandardNth2dalpha2))));
    
    CCTK_REAL_VEC Ats23 CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(0.166666666666666666666666666667),kmadd(dalpha3L,dphi2L,kmul(dalpha2L,dphi3L)),kmadd(dalpha1L,Gt123,kmadd(dalpha2L,Gt223,kmadd(dalpha3L,Gt323,kmsub(alphaL,R23,JacPDstandardNth2dalpha3)))));
    
    CCTK_REAL_VEC Ats33 CCTK_ATTRIBUTE_UNUSED = 
      kmadd(dalpha1L,Gt133,kmadd(dalpha2L,Gt233,kmadd(dalpha3L,kmadd(ToReal(0.333333333333333333333333333333),dphi3L,Gt333),kmsub(alphaL,R33,JacPDstandardNth3dalpha3))));
    
    CCTK_REAL_VEC trAts CCTK_ATTRIBUTE_UNUSED = 
      kmadd(Ats11,gu11,kmadd(Ats22,gu22,kmadd(ToReal(2),kmadd(Ats12,gu21,kmadd(Ats13,gu31,kmul(Ats23,gu32))),kmul(Ats33,gu33))));
    
    CCTK_REAL_VEC At11rhsL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(2),kmadd(At11L,dbeta11L,kmadd(At12L,dbeta12L,kmul(At13L,dbeta13L))),kmadd(At11L,kmadd(ToReal(-0.666666666666666666666666666667),kadd(dbeta11L,kadd(dbeta22L,dbeta33L)),kmul(alphaL,trKL)),kmadd(beta1L,JacPDupwindNthAnti1At11,kmadd(beta2L,JacPDupwindNthAnti2At11,kmadd(beta3L,JacPDupwindNthAnti3At11,kmadd(em4phi,kmadd(ToReal(-0.333333333333333333333333333333),kmul(g11,trAts),Ats11),kmadd(alphaL,kmadd(ToReal(-2),kmadd(At11L,Atm11,kmadd(At12L,Atm21,kmul(At13L,Atm31))),kmul(kmul(em4phi,kmadd(ToReal(-0.333333333333333333333333333333),kmul(g11,trS),eTxxL)),ToReal(-25.13274122871834590770114706623602307358))),kmadd(JacPDupwindNthSymm1At11,kfabs(beta1L),kmadd(JacPDupwindNthSymm2At11,kfabs(beta2L),kmul(JacPDupwindNthSymm3At11,kfabs(beta3L)))))))))));
    
    CCTK_REAL_VEC At12rhsL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(At22L,dbeta12L,kmadd(At23L,dbeta13L,kmadd(At11L,dbeta21L,kmadd(At13L,dbeta23L,kmadd(At12L,kadd(dbeta11L,kadd(dbeta22L,kmadd(ToReal(-0.666666666666666666666666666667),kadd(dbeta11L,kadd(dbeta22L,dbeta33L)),kmul(alphaL,trKL)))),kmadd(beta1L,JacPDupwindNthAnti1At12,kmadd(beta2L,JacPDupwindNthAnti2At12,kmadd(beta3L,JacPDupwindNthAnti3At12,kmadd(em4phi,kmadd(ToReal(-0.333333333333333333333333333333),kmul(g12,trAts),Ats12),kmadd(alphaL,kmadd(ToReal(-2),kmadd(At11L,Atm12,kmadd(At12L,Atm22,kmul(At13L,Atm32))),kmul(kmul(em4phi,kmadd(ToReal(-0.333333333333333333333333333333),kmul(g12,trS),eTxyL)),ToReal(-25.13274122871834590770114706623602307358))),kmadd(JacPDupwindNthSymm1At12,kfabs(beta1L),kmadd(JacPDupwindNthSymm2At12,kfabs(beta2L),kmul(JacPDupwindNthSymm3At12,kfabs(beta3L))))))))))))));
    
    CCTK_REAL_VEC At13rhsL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(At23L,dbeta12L,kmadd(At33L,dbeta13L,kmadd(At11L,dbeta31L,kmadd(At12L,dbeta32L,kmadd(At13L,kadd(dbeta11L,kadd(dbeta33L,kmadd(ToReal(-0.666666666666666666666666666667),kadd(dbeta11L,kadd(dbeta22L,dbeta33L)),kmul(alphaL,trKL)))),kmadd(beta1L,JacPDupwindNthAnti1At13,kmadd(beta2L,JacPDupwindNthAnti2At13,kmadd(beta3L,JacPDupwindNthAnti3At13,kmadd(em4phi,kmadd(ToReal(-0.333333333333333333333333333333),kmul(g13,trAts),Ats13),kmadd(alphaL,kmadd(ToReal(-2),kmadd(At11L,Atm13,kmadd(At12L,Atm23,kmul(At13L,Atm33))),kmul(kmul(em4phi,kmadd(ToReal(-0.333333333333333333333333333333),kmul(g13,trS),eTxzL)),ToReal(-25.13274122871834590770114706623602307358))),kmadd(JacPDupwindNthSymm1At13,kfabs(beta1L),kmadd(JacPDupwindNthSymm2At13,kfabs(beta2L),kmul(JacPDupwindNthSymm3At13,kfabs(beta3L))))))))))))));
    
    CCTK_REAL_VEC At22rhsL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(2),kmadd(At12L,dbeta21L,kmadd(At22L,dbeta22L,kmul(At23L,dbeta23L))),kmadd(At22L,kmadd(ToReal(-0.666666666666666666666666666667),kadd(dbeta11L,kadd(dbeta22L,dbeta33L)),kmul(alphaL,trKL)),kmadd(beta1L,JacPDupwindNthAnti1At22,kmadd(beta2L,JacPDupwindNthAnti2At22,kmadd(beta3L,JacPDupwindNthAnti3At22,kmadd(em4phi,kmadd(ToReal(-0.333333333333333333333333333333),kmul(g22,trAts),Ats22),kmadd(alphaL,kmadd(ToReal(-2),kmadd(At12L,Atm12,kmadd(At22L,Atm22,kmul(At23L,Atm32))),kmul(kmul(em4phi,kmadd(ToReal(-0.333333333333333333333333333333),kmul(g22,trS),eTyyL)),ToReal(-25.13274122871834590770114706623602307358))),kmadd(JacPDupwindNthSymm1At22,kfabs(beta1L),kmadd(JacPDupwindNthSymm2At22,kfabs(beta2L),kmul(JacPDupwindNthSymm3At22,kfabs(beta3L)))))))))));
    
    CCTK_REAL_VEC At23rhsL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(At13L,dbeta21L,kmadd(At33L,dbeta23L,kmadd(At12L,kmadd(ToReal(-2.),kmul(alphaL,Atm13),dbeta31L),kmadd(At22L,kmadd(ToReal(-2.),kmul(alphaL,Atm23),dbeta32L),kmadd(At23L,kmadd(ToReal(-0.6666666666666666666666666666666666666667),dbeta11L,kmadd(ToReal(0.3333333333333333333333333333333333333333),kadd(dbeta22L,dbeta33L),kmul(alphaL,kmadd(ToReal(-2.),Atm33,trKL)))),kmadd(beta1L,JacPDupwindNthAnti1At23,kmadd(beta2L,JacPDupwindNthAnti2At23,kmadd(beta3L,JacPDupwindNthAnti3At23,kmadd(em4phi,kadd(Ats23,kmadd(ToReal(-0.3333333333333333333333333333333333333333),kmul(g23,trAts),kmul(alphaL,kmadd(ToReal(-25.13274122871834590770114706623602307358),eTyzL,kmul(kmul(g23,trS),ToReal(8.377580409572781969233715688745341024526)))))),kmadd(JacPDupwindNthSymm1At23,kfabs(beta1L),kmadd(JacPDupwindNthSymm2At23,kfabs(beta2L),kmul(JacPDupwindNthSymm3At23,kfabs(beta3L)))))))))))));
    
    CCTK_REAL_VEC At33rhsL CCTK_ATTRIBUTE_UNUSED = 
      kmadd(ToReal(2),kmadd(At13L,dbeta31L,kmadd(At23L,dbeta32L,kmul(At33L,dbeta33L))),kmadd(At33L,kmadd(ToReal(-0.666666666666666666666666666667),kadd(dbeta11L,kadd(dbeta22L,dbeta33L)),kmul(alphaL,trKL)),kmadd(beta1L,JacPDupwindNthAnti1At33,kmadd(beta2L,JacPDupwindNthAnti2At33,kmadd(beta3L,JacPDupwindNthAnti3At33,kmadd(em4phi,kmadd(ToReal(-0.333333333333333333333333333333),kmul(g33,trAts),Ats33),kmadd(alphaL,kmadd(ToReal(-2),kmadd(At13L,Atm13,kmadd(At23L,Atm23,kmul(At33L,Atm33))),kmul(kmul(em4phi,kmadd(ToReal(-0.333333333333333333333333333333),kmul(g33,trS),eTzzL)),ToReal(-25.13274122871834590770114706623602307358))),kmadd(JacPDupwindNthSymm1At33,kfabs(beta1L),kmadd(JacPDupwindNthSymm2At33,kfabs(beta2L),kmul(JacPDupwindNthSymm3At33,kfabs(beta3L)))))))))));
    /* Copy local copies back to grid functions */
  ...
  CCTK_ENDLOOP3STR(CL_BSSN_RHS2);
}
extern "C" void CL_BSSN_RHS2(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CL_BSSN_RHS2
  DECLARE_CCTK_ARGUMENTS_CHECKED(CL_BSSN_RHS2);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CL_BSSN_RHS2_Body");
  }
  if (cctk_iteration % CL_BSSN_RHS2_calc_every != CL_BSSN_RHS2_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "CL_BSSN_RHS2", 13, groups);
  
  switch (fdOrder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "CL_BSSN_RHS2", 2, 2, 2);
      break;
    }
    
    case 4:
    {
      EnsureStencilFits(cctkGH, "CL_BSSN_RHS2", 3, 3, 3);
      break;
    }
    
    case 6:
    {
      EnsureStencilFits(cctkGH, "CL_BSSN_RHS2", 4, 4, 4);
      break;
    }
    
    case 8:
    {
      EnsureStencilFits(cctkGH, "CL_BSSN_RHS2", 5, 5, 5);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
  ...
  LoopOverInterior(cctkGH, CL_BSSN_RHS2_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CL_BSSN_RHS2_Body");
  }
}
