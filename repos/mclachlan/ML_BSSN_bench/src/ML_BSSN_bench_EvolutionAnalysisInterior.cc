...
extern "C" void ML_BSSN_bench_EvolutionAnalysisInterior_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_bench_EvolutionAnalysisInterior_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_bench_EvolutionAnalysisInterior_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % ML_BSSN_bench_EvolutionAnalysisInterior_calc_every != ML_BSSN_bench_EvolutionAnalysisInterior_calc_offset)
    return;
  CCTK_INT ierr CCTK_ATTRIBUTE_UNUSED = 0;
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench::ML_curvrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench::ML_curvrhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench::ML_dtshiftrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench::ML_dtshiftrhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench::ML_Gammarhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench::ML_Gammarhs.");
  ...
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench::ML_shiftrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench::ML_shiftrhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench::ML_trace_curvrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench::ML_trace_curvrhs.");
  return;
}

static void ML_BSSN_bench_EvolutionAnalysisInterior_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3STR(ML_BSSN_bench_EvolutionAnalysisInterior,
    ...
    vecimin,vecimax, CCTK_REAL_VEC_SIZE)
  {
    ...
    {
      dotbeta1 = 
        kmul(B1L,kmul(shiftGammaCoeffValue,kpow(alphaL,shiftAlphaPower)));
      
      dotbeta2 = 
        kmul(B2L,kmul(shiftGammaCoeffValue,kpow(alphaL,shiftAlphaPower)));
      
      dotbeta3 = 
        kmul(B3L,kmul(shiftGammaCoeffValue,kpow(alphaL,shiftAlphaPower)));
    }
    else
    {
      dotbeta1 = 
  ...
  CCTK_ENDLOOP3STR(ML_BSSN_bench_EvolutionAnalysisInterior);
}
extern "C" void ML_BSSN_bench_EvolutionAnalysisInterior(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_bench_EvolutionAnalysisInterior
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_bench_EvolutionAnalysisInterior);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ML_BSSN_bench_EvolutionAnalysisInterior_Body");
  }
  if (cctk_iteration % ML_BSSN_bench_EvolutionAnalysisInterior_calc_every != ML_BSSN_bench_EvolutionAnalysisInterior_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "ML_BSSN_bench::ML_curvrhs",
    "ML_BSSN_bench::ML_dtshift",
    "ML_BSSN_bench::ML_dtshiftrhs",
    "ML_BSSN_bench::ML_Gamma",
    "ML_BSSN_bench::ML_Gammarhs",
    ...
    "ML_BSSN_bench::ML_shiftrhs",
    "ML_BSSN_bench::ML_trace_curv",
    "ML_BSSN_bench::ML_trace_curvrhs"};
  AssertGroupStorage(cctkGH, "ML_BSSN_bench_EvolutionAnalysisInterior", 17, groups);
  
  switch (fdOrder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_bench_EvolutionAnalysisInterior", 2, 2, 2);
      break;
    }
    
    case 4:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_bench_EvolutionAnalysisInterior", 3, 3, 3);
      break;
    }
    
    case 6:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_bench_EvolutionAnalysisInterior", 4, 4, 4);
      break;
    }
    
    case 8:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_bench_EvolutionAnalysisInterior", 5, 5, 5);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
  ...
  LoopOverInterior(cctkGH, ML_BSSN_bench_EvolutionAnalysisInterior_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ML_BSSN_bench_EvolutionAnalysisInterior_Body");
  }
}
