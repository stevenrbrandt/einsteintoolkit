...
#define THORN_ML_BSSN_bench // "ML_BSSN_bench" will be replaced
#ifdef THORN_ML_CCZ4
#define HAVE_THETA
#endif
...
int ML_BSSN_bench_SetGroupTags(void) {
  ...
  set_group_tags(other_global, other_global, other_global, "ML_BSSN_bench::ML_Ham");
  set_group_tags(other_global, other_global, other_global, "ML_BSSN_bench::ML_mom");

  // RHS variables do not have valid boundaries
  bool rhs_global = rhs_timelevels > 1;
  set_group_tags(rhs_global, rhs_global, false, "ML_BSSN_bench::ML_log_confacrhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_BSSN_bench::ML_metricrhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_BSSN_bench::ML_Gammarhs");

#ifdef HAVE_THETA
  set_group_tags(rhs_global, rhs_global, false, "ML_BSSN_bench::ML_Thetarhs");
#endif
  set_group_tags(rhs_global, rhs_global, false, "ML_BSSN_bench::ML_trace_curvrhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_BSSN_bench::ML_curvrhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_BSSN_bench::ML_lapserhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_BSSN_bench::ML_dtlapserhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_BSSN_bench::ML_shiftrhs");
  set_group_tags(rhs_global, rhs_global, false, "ML_BSSN_bench::ML_dtshiftrhs");
