...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_InitialADMBase2Interior_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_InitialADMBase2Interior_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_InitialADMBase2Interior
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_InitialADMBase2Interior);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
