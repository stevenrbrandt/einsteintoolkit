...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_EvolutionBoundaryScalar_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_EvolutionBoundaryScalar_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_EvolutionBoundaryScalar
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_EvolutionBoundaryScalar);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
