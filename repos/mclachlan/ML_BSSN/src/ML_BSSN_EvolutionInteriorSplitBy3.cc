...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_EvolutionInteriorSplitBy3_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_EvolutionInteriorSplitBy3_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_EvolutionInteriorSplitBy3
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_EvolutionInteriorSplitBy3);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
