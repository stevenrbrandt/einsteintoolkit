...
{
#ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_CheckBoundaries
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_CheckBoundaries);
#else
...
{
#ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_SelectBoundConds
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_SelectBoundConds);
#else
  DECLARE_CCTK_ARGUMENTS;
#endif
  DECLARE_CCTK_PARAMETERS;
