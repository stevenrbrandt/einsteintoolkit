...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_ADMBaseBoundaryScalar_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_ADMBaseBoundaryScalar_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_ADMBaseBoundaryScalar
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_ADMBaseBoundaryScalar);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
