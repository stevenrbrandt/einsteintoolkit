...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_ConstraintsEverywhere_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_ConstraintsEverywhere_SelectBCs);
  #else
  ...
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN::ML_cons_detg","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN::ML_cons_detg.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN::ML_cons_traceA","flat");
  if (ierr < 0)
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_ConstraintsEverywhere
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_ConstraintsEverywhere);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
