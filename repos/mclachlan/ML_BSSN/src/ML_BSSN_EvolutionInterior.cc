...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_EvolutionInterior_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_EvolutionInterior_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_EvolutionInterior
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_EvolutionInterior);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
