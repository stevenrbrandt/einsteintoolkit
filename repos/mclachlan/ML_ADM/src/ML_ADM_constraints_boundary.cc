...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_ADM_constraints_boundary_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_ADM_constraints_boundary_SelectBCs);
  #else
...
static void ML_ADM_constraints_boundary_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  CCTK_ENDLOOP3STR(ML_ADM_constraints_boundary);
}
extern "C" void ML_ADM_constraints_boundary(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_ADM_constraints_boundary
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_ADM_constraints_boundary);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  const char* const groups[] = {
    "ML_ADM::ML_Ham",
    "ML_ADM::ML_mom"};
  AssertGroupStorage(cctkGH, "ML_ADM_constraints_boundary", 2, groups);
  ...
  LoopOverBoundaryWithGhosts(cctkGH, ML_ADM_constraints_boundary_Body);
  if (verbose > 1)
  {
