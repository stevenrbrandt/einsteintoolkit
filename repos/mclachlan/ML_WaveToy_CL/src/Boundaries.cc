...
extern "C" void ML_WaveToy_CL_CheckBoundaries(CCTK_ARGUMENTS)
{
#ifdef DECLARE_CCTK_ARGUMENTS_ML_WaveToy_CL_CheckBoundaries
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_WaveToy_CL_CheckBoundaries);
#else
...
extern "C" void ML_WaveToy_CL_SelectBoundConds(CCTK_ARGUMENTS)
{
#ifdef DECLARE_CCTK_ARGUMENTS_ML_WaveToy_CL_SelectBoundConds
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_WaveToy_CL_SelectBoundConds);
#else
  DECLARE_CCTK_ARGUMENTS;
#endif
  DECLARE_CCTK_PARAMETERS;
      ...
      CCTK_EQUALS(WT_u_bound, "zero"  ) )
  {
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_WaveToy_CL::WT_u", WT_u_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register WT_u_bound BC for ML_WaveToy_CL::WT_u!");
  }
      ...
      CCTK_EQUALS(WT_rho_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register WT_rho_bound BC for ML_WaveToy_CL::WT_rho!");
  }
      ...
      CCTK_EQUALS(u_bound, "zero"  ) )
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_WaveToy_CL::u", u_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register u_bound BC for ML_WaveToy_CL::u!");
  }
      ...
      CCTK_EQUALS(rho_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register rho_bound BC for ML_WaveToy_CL::rho!");
  }
  ...
  if (CCTK_EQUALS(WT_u_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_WT_u_bound, 
                      "ML_WaveToy_CL::WT_u", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_WaveToy_CL::WT_u!");
  ...
  if (CCTK_EQUALS(WT_rho_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_WaveToy_CL::WT_rho!");
  ...
  if (CCTK_EQUALS(u_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_u_bound, 
                      "ML_WaveToy_CL::u", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_WaveToy_CL::u!");
  ...
  if (CCTK_EQUALS(rho_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_WaveToy_CL::rho!");
  ...
  if (CCTK_EQUALS(WT_u_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_WT_u_bound, 
                      "ML_WaveToy_CL::WT_u", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_WaveToy_CL::WT_u!");
  ...
  if (CCTK_EQUALS(WT_rho_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_WaveToy_CL::WT_rho!");
  ...
  if (CCTK_EQUALS(u_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_u_bound, 
                      "ML_WaveToy_CL::u", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_WaveToy_CL::u!");
  ...
  if (CCTK_EQUALS(rho_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_WaveToy_CL::rho!");
