...
static void ML_BSSN_NV_ADMBaseEverywhere_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3(ML_BSSN_NV_ADMBaseEverywhere,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL gxxL CCTK_ATTRIBUTE_UNUSED = g11;
    
    CCTK_REAL gxyL CCTK_ATTRIBUTE_UNUSED = g12;
    
    CCTK_REAL gxzL CCTK_ATTRIBUTE_UNUSED = g13;
    
    CCTK_REAL gyyL CCTK_ATTRIBUTE_UNUSED = g22;
    
    CCTK_REAL gyzL CCTK_ATTRIBUTE_UNUSED = g23;
    
    CCTK_REAL gzzL CCTK_ATTRIBUTE_UNUSED = g33;
    
    CCTK_REAL kxxL CCTK_ATTRIBUTE_UNUSED = At11L*e4phi + 
      0.333333333333333333333333333333*trKL*g11;
    
    CCTK_REAL kxyL CCTK_ATTRIBUTE_UNUSED = At12L*e4phi + 
      0.333333333333333333333333333333*trKL*g12;
    
    CCTK_REAL kxzL CCTK_ATTRIBUTE_UNUSED = At13L*e4phi + 
      0.333333333333333333333333333333*trKL*g13;
    
    CCTK_REAL kyyL CCTK_ATTRIBUTE_UNUSED = At22L*e4phi + 
      0.333333333333333333333333333333*trKL*g22;
    
    CCTK_REAL kyzL CCTK_ATTRIBUTE_UNUSED = At23L*e4phi + 
      0.333333333333333333333333333333*trKL*g23;
    
    CCTK_REAL kzzL CCTK_ATTRIBUTE_UNUSED = At33L*e4phi + 
  ...
  CCTK_ENDLOOP3(ML_BSSN_NV_ADMBaseEverywhere);
}
extern "C" void ML_BSSN_NV_ADMBaseEverywhere(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_NV_ADMBaseEverywhere
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_NV_ADMBaseEverywhere);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ML_BSSN_NV_ADMBaseEverywhere_Body");
  }
  if (cctk_iteration % ML_BSSN_NV_ADMBaseEverywhere_calc_every != ML_BSSN_NV_ADMBaseEverywhere_calc_offset)
  {
    return;
  }
  ...
  AssertGroupStorage(cctkGH, "ML_BSSN_NV_ADMBaseEverywhere", 10, groups);
  ...
  LoopOverEverything(cctkGH, ML_BSSN_NV_ADMBaseEverywhere_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ML_BSSN_NV_ADMBaseEverywhere_Body");
  }
}
