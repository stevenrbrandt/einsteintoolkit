...
extern "C" void ML_CCZ4_ConstraintsEverywhere_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_CCZ4_ConstraintsEverywhere_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_CCZ4_ConstraintsEverywhere_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % ML_CCZ4_ConstraintsEverywhere_calc_every != ML_CCZ4_ConstraintsEverywhere_calc_offset)
    return;
  CCTK_INT ierr CCTK_ATTRIBUTE_UNUSED = 0;
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_CCZ4::ML_cons_detg","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_CCZ4::ML_cons_detg.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_CCZ4::ML_cons_traceA","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_CCZ4::ML_cons_traceA.");
  return;
}

static void ML_CCZ4_ConstraintsEverywhere_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3STR(ML_CCZ4_ConstraintsEverywhere,
  ...
  CCTK_ENDLOOP3STR(ML_CCZ4_ConstraintsEverywhere);
}
extern "C" void ML_CCZ4_ConstraintsEverywhere(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_CCZ4_ConstraintsEverywhere
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_CCZ4_ConstraintsEverywhere);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ML_CCZ4_ConstraintsEverywhere_Body");
  }
  if (cctk_iteration % ML_CCZ4_ConstraintsEverywhere_calc_every != ML_CCZ4_ConstraintsEverywhere_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "ML_CCZ4::ML_curv",
    "ML_CCZ4::ML_metric"};
  AssertGroupStorage(cctkGH, "ML_CCZ4_ConstraintsEverywhere", 4, groups);
  ...
  LoopOverInterior(cctkGH, ML_CCZ4_ConstraintsEverywhere_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ML_CCZ4_ConstraintsEverywhere_Body");
  }
}
