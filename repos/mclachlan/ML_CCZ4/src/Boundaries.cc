...
{
#ifdef DECLARE_CCTK_ARGUMENTS_ML_CCZ4_CheckBoundaries
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_CCZ4_CheckBoundaries);
#else
...
{
#ifdef DECLARE_CCTK_ARGUMENTS_ML_CCZ4_SelectBoundConds
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_CCZ4_SelectBoundConds);
#else
  DECLARE_CCTK_ARGUMENTS;
#endif
  DECLARE_CCTK_PARAMETERS;
      ...
      CCTK_EQUALS(ML_log_confac_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_log_confac_bound BC for ML_CCZ4::ML_log_confac!");
  }
      ...
      CCTK_EQUALS(ML_metric_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_metric_bound BC for ML_CCZ4::ML_metric!");
  }
      ...
      CCTK_EQUALS(ML_Gamma_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_Gamma_bound BC for ML_CCZ4::ML_Gamma!");
  }
      ...
      CCTK_EQUALS(ML_trace_curv_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_trace_curv_bound BC for ML_CCZ4::ML_trace_curv!");
  }
      ...
      CCTK_EQUALS(ML_curv_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_curv_bound BC for ML_CCZ4::ML_curv!");
  }
      ...
      CCTK_EQUALS(ML_Theta_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_Theta_bound BC for ML_CCZ4::ML_Theta!");
  }
      ...
      CCTK_EQUALS(ML_lapse_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_lapse_bound BC for ML_CCZ4::ML_lapse!");
  }
      ...
      CCTK_EQUALS(ML_dtlapse_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_dtlapse_bound BC for ML_CCZ4::ML_dtlapse!");
  }
      ...
      CCTK_EQUALS(ML_shift_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_shift_bound BC for ML_CCZ4::ML_shift!");
  }
      ...
      CCTK_EQUALS(ML_dtshift_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_dtshift_bound BC for ML_CCZ4::ML_dtshift!");
  }
      ...
      CCTK_EQUALS(phi_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register phi_bound BC for ML_CCZ4::phi!");
  }
      ...
      CCTK_EQUALS(gt11_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt11_bound BC for ML_CCZ4::gt11!");
  }
      ...
      CCTK_EQUALS(gt12_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt12_bound BC for ML_CCZ4::gt12!");
  }
      ...
      CCTK_EQUALS(gt13_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt13_bound BC for ML_CCZ4::gt13!");
  }
      ...
      CCTK_EQUALS(gt22_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt22_bound BC for ML_CCZ4::gt22!");
  }
      ...
      CCTK_EQUALS(gt23_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt23_bound BC for ML_CCZ4::gt23!");
  }
      ...
      CCTK_EQUALS(gt33_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt33_bound BC for ML_CCZ4::gt33!");
  }
      ...
      CCTK_EQUALS(Xt1_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Xt1_bound BC for ML_CCZ4::Xt1!");
  }
      ...
      CCTK_EQUALS(Xt2_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Xt2_bound BC for ML_CCZ4::Xt2!");
  }
      ...
      CCTK_EQUALS(Xt3_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Xt3_bound BC for ML_CCZ4::Xt3!");
  }
      ...
      CCTK_EQUALS(trK_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register trK_bound BC for ML_CCZ4::trK!");
  }
      ...
      CCTK_EQUALS(At11_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register At11_bound BC for ML_CCZ4::At11!");
  }
      ...
      CCTK_EQUALS(At12_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register At12_bound BC for ML_CCZ4::At12!");
  }
      ...
      CCTK_EQUALS(At13_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register At13_bound BC for ML_CCZ4::At13!");
  }
      ...
      CCTK_EQUALS(At22_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register At22_bound BC for ML_CCZ4::At22!");
  }
      ...
      CCTK_EQUALS(At23_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register At23_bound BC for ML_CCZ4::At23!");
  }
      ...
      CCTK_EQUALS(At33_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register At33_bound BC for ML_CCZ4::At33!");
  }
      ...
      CCTK_EQUALS(Theta_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Theta_bound BC for ML_CCZ4::Theta!");
  }
      ...
      CCTK_EQUALS(alpha_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register alpha_bound BC for ML_CCZ4::alpha!");
  }
      ...
      CCTK_EQUALS(A_bound, "zero"  ) )
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_CCZ4::A", A_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register A_bound BC for ML_CCZ4::A!");
  }
      ...
      CCTK_EQUALS(beta1_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register beta1_bound BC for ML_CCZ4::beta1!");
  }
      ...
      CCTK_EQUALS(beta2_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register beta2_bound BC for ML_CCZ4::beta2!");
  }
      ...
      CCTK_EQUALS(beta3_bound, "zero"  ) )
  {
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register beta3_bound BC for ML_CCZ4::beta3!");
  }
      ...
      CCTK_EQUALS(B1_bound, "zero"  ) )
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_CCZ4::B1", B1_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register B1_bound BC for ML_CCZ4::B1!");
  }
      ...
      CCTK_EQUALS(B2_bound, "zero"  ) )
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_CCZ4::B2", B2_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register B2_bound BC for ML_CCZ4::B2!");
  }
      ...
      CCTK_EQUALS(B3_bound, "zero"  ) )
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_CCZ4::B3", B3_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register B3_bound BC for ML_CCZ4::B3!");
  }
  ...
  if (CCTK_EQUALS(ML_log_confac_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::ML_log_confac!");
  ...
  if (CCTK_EQUALS(ML_metric_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::ML_metric!");
  ...
  if (CCTK_EQUALS(ML_Gamma_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::ML_Gamma!");
  ...
  if (CCTK_EQUALS(ML_trace_curv_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::ML_trace_curv!");
  ...
  if (CCTK_EQUALS(ML_curv_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::ML_curv!");
  ...
  if (CCTK_EQUALS(ML_Theta_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::ML_Theta!");
  ...
  if (CCTK_EQUALS(ML_lapse_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::ML_lapse!");
  ...
  if (CCTK_EQUALS(ML_dtlapse_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::ML_dtlapse!");
  ...
  if (CCTK_EQUALS(ML_shift_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::ML_shift!");
  ...
  if (CCTK_EQUALS(ML_dtshift_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::ML_dtshift!");
  ...
  if (CCTK_EQUALS(phi_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::phi!");
  ...
  if (CCTK_EQUALS(gt11_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::gt11!");
  ...
  if (CCTK_EQUALS(gt12_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::gt12!");
  ...
  if (CCTK_EQUALS(gt13_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::gt13!");
  ...
  if (CCTK_EQUALS(gt22_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::gt22!");
  ...
  if (CCTK_EQUALS(gt23_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::gt23!");
  ...
  if (CCTK_EQUALS(gt33_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::gt33!");
  ...
  if (CCTK_EQUALS(Xt1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::Xt1!");
  ...
  if (CCTK_EQUALS(Xt2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::Xt2!");
  ...
  if (CCTK_EQUALS(Xt3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::Xt3!");
  ...
  if (CCTK_EQUALS(trK_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::trK!");
  ...
  if (CCTK_EQUALS(At11_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::At11!");
  ...
  if (CCTK_EQUALS(At12_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::At12!");
  ...
  if (CCTK_EQUALS(At13_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::At13!");
  ...
  if (CCTK_EQUALS(At22_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::At22!");
  ...
  if (CCTK_EQUALS(At23_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::At23!");
  ...
  if (CCTK_EQUALS(At33_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::At33!");
  ...
  if (CCTK_EQUALS(Theta_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::Theta!");
  ...
  if (CCTK_EQUALS(alpha_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::alpha!");
  ...
  if (CCTK_EQUALS(A_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::A!");
  ...
  if (CCTK_EQUALS(beta1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::beta1!");
  ...
  if (CCTK_EQUALS(beta2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::beta2!");
  ...
  if (CCTK_EQUALS(beta3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::beta3!");
  ...
  if (CCTK_EQUALS(B1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::B1!");
  ...
  if (CCTK_EQUALS(B2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::B2!");
  ...
  if (CCTK_EQUALS(B3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_CCZ4::B3!");
  ...
  if (CCTK_EQUALS(ML_log_confac_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_CCZ4::ML_log_confac!");
  ...
  if (CCTK_EQUALS(ML_metric_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_CCZ4::ML_metric!");
  ...
  if (CCTK_EQUALS(ML_Gamma_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_CCZ4::ML_Gamma!");
  ...
  if (CCTK_EQUALS(ML_trace_curv_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_CCZ4::ML_trace_curv!");
  ...
  if (CCTK_EQUALS(ML_curv_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_CCZ4::ML_curv!");
  ...
  if (CCTK_EQUALS(ML_Theta_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_CCZ4::ML_Theta!");
  ...
  if (CCTK_EQUALS(ML_lapse_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_CCZ4::ML_lapse!");
  ...
  if (CCTK_EQUALS(ML_dtlapse_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_CCZ4::ML_dtlapse!");
  ...
  if (CCTK_EQUALS(ML_shift_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_CCZ4::ML_shift!");
  ...
  if (CCTK_EQUALS(ML_dtshift_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_CCZ4::ML_dtshift!");
  ...
  if (CCTK_EQUALS(phi_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::phi!");
  ...
  if (CCTK_EQUALS(gt11_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::gt11!");
  ...
  if (CCTK_EQUALS(gt12_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::gt12!");
  ...
  if (CCTK_EQUALS(gt13_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::gt13!");
  ...
  if (CCTK_EQUALS(gt22_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::gt22!");
  ...
  if (CCTK_EQUALS(gt23_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::gt23!");
  ...
  if (CCTK_EQUALS(gt33_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::gt33!");
  ...
  if (CCTK_EQUALS(Xt1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::Xt1!");
  ...
  if (CCTK_EQUALS(Xt2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::Xt2!");
  ...
  if (CCTK_EQUALS(Xt3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::Xt3!");
  ...
  if (CCTK_EQUALS(trK_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::trK!");
  ...
  if (CCTK_EQUALS(At11_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::At11!");
  ...
  if (CCTK_EQUALS(At12_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::At12!");
  ...
  if (CCTK_EQUALS(At13_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::At13!");
  ...
  if (CCTK_EQUALS(At22_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::At22!");
  ...
  if (CCTK_EQUALS(At23_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::At23!");
  ...
  if (CCTK_EQUALS(At33_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::At33!");
  ...
  if (CCTK_EQUALS(Theta_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::Theta!");
  ...
  if (CCTK_EQUALS(alpha_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::alpha!");
  ...
  if (CCTK_EQUALS(A_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::A!");
  ...
  if (CCTK_EQUALS(beta1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::beta1!");
  ...
  if (CCTK_EQUALS(beta2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::beta2!");
  ...
  if (CCTK_EQUALS(beta3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::beta3!");
  ...
  if (CCTK_EQUALS(B1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::B1!");
  ...
  if (CCTK_EQUALS(B2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::B2!");
  ...
  if (CCTK_EQUALS(B3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_CCZ4::B3!");
