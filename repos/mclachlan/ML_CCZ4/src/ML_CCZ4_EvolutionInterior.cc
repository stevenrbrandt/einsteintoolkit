...
extern "C" void ML_CCZ4_EvolutionInterior_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_CCZ4_EvolutionInterior_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_CCZ4_EvolutionInterior_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % ML_CCZ4_EvolutionInterior_calc_every != ML_CCZ4_EvolutionInterior_calc_offset)
    return;
...
static void ML_CCZ4_EvolutionInterior_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3STR(ML_CCZ4_EvolutionInterior,
  ...
  CCTK_ENDLOOP3STR(ML_CCZ4_EvolutionInterior);
}
extern "C" void ML_CCZ4_EvolutionInterior(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_CCZ4_EvolutionInterior
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_CCZ4_EvolutionInterior);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ML_CCZ4_EvolutionInterior_Body");
  }
  if (cctk_iteration % ML_CCZ4_EvolutionInterior_calc_every != ML_CCZ4_EvolutionInterior_calc_offset)
  {
    return;
  ...
  AssertGroupStorage(cctkGH, "ML_CCZ4_EvolutionInterior", 21, groups);
  
  switch (fdOrder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "ML_CCZ4_EvolutionInterior", 2, 2, 2);
      break;
    }
    
    case 4:
    {
      EnsureStencilFits(cctkGH, "ML_CCZ4_EvolutionInterior", 3, 3, 3);
      break;
    }
    
    case 6:
    {
      EnsureStencilFits(cctkGH, "ML_CCZ4_EvolutionInterior", 4, 4, 4);
      break;
    }
    
    case 8:
    {
      EnsureStencilFits(cctkGH, "ML_CCZ4_EvolutionInterior", 5, 5, 5);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
  ...
  LoopOverInterior(cctkGH, ML_CCZ4_EvolutionInterior_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ML_CCZ4_EvolutionInterior_Body");
  }
}
