...
static void ML_CCZ4_ADMBaseInterior_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3STR(ML_CCZ4_ADMBaseInterior,
  ...
  CCTK_ENDLOOP3STR(ML_CCZ4_ADMBaseInterior);
}
extern "C" void ML_CCZ4_ADMBaseInterior(CCTK_ARGUMENTS)
{
  ...
  AssertGroupStorage(cctkGH, "ML_CCZ4_ADMBaseInterior", 12, groups);
  
  switch (fdOrder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "ML_CCZ4_ADMBaseInterior", 2, 2, 2);
      break;
    }
    
    case 4:
    {
      EnsureStencilFits(cctkGH, "ML_CCZ4_ADMBaseInterior", 3, 3, 3);
      break;
    }
    
    case 6:
    {
      EnsureStencilFits(cctkGH, "ML_CCZ4_ADMBaseInterior", 4, 4, 4);
      break;
    }
