...
static void ML_CCZ4_EvolutionAnalysisInit_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3STR(ML_CCZ4_EvolutionAnalysisInit,
  ...
  CCTK_ENDLOOP3STR(ML_CCZ4_EvolutionAnalysisInit);
}
extern "C" void ML_CCZ4_EvolutionAnalysisInit(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_CCZ4_EvolutionAnalysisInit
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_CCZ4_EvolutionAnalysisInit);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ML_CCZ4_EvolutionAnalysisInit_Body");
  }
  if (cctk_iteration % ML_CCZ4_EvolutionAnalysisInit_calc_every != ML_CCZ4_EvolutionAnalysisInit_calc_offset)
  {
    return;
  }
  ...
  AssertGroupStorage(cctkGH, "ML_CCZ4_EvolutionAnalysisInit", 10, groups);
  ...
  LoopOverEverything(cctkGH, ML_CCZ4_EvolutionAnalysisInit_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ML_CCZ4_EvolutionAnalysisInit_Body");
  }
}
