...
static void ML_CCZ4_ADMBaseEverywhere_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  #pragma omp parallel
  CCTK_LOOP3STR(ML_CCZ4_ADMBaseEverywhere,
  ...
  CCTK_ENDLOOP3STR(ML_CCZ4_ADMBaseEverywhere);
}
extern "C" void ML_CCZ4_ADMBaseEverywhere(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_CCZ4_ADMBaseEverywhere
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_CCZ4_ADMBaseEverywhere);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ML_CCZ4_ADMBaseEverywhere_Body");
  }
  if (cctk_iteration % ML_CCZ4_ADMBaseEverywhere_calc_every != ML_CCZ4_ADMBaseEverywhere_calc_offset)
  {
    return;
  }
  ...
  AssertGroupStorage(cctkGH, "ML_CCZ4_ADMBaseEverywhere", 10, groups);
  ...
  LoopOverEverything(cctkGH, ML_CCZ4_ADMBaseEverywhere_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ML_CCZ4_ADMBaseEverywhere_Body");
  }
}
