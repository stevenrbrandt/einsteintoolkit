...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_CCZ4_ADMBaseBoundaryScalar_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_CCZ4_ADMBaseBoundaryScalar_SelectBCs);
  #else
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_CCZ4_ADMBaseBoundaryScalar
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_CCZ4_ADMBaseBoundaryScalar);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
