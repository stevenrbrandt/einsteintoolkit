...
namespace ML_BSSN_bench8 {

extern "C" void ML_BSSN_bench8_EvolutionAnalysisInterior_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_bench8_EvolutionAnalysisInterior_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_bench8_EvolutionAnalysisInterior_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % ML_BSSN_bench8_EvolutionAnalysisInterior_calc_every != ML_BSSN_bench8_EvolutionAnalysisInterior_calc_offset)
    return;
  CCTK_INT ierr CCTK_ATTRIBUTE_UNUSED = 0;
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench8::ML_curvrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench8::ML_curvrhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench8::ML_Gammarhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench8::ML_Gammarhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench8::ML_lapserhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench8::ML_lapserhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench8::ML_log_confacrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench8::ML_log_confacrhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench8::ML_metricrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench8::ML_metricrhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench8::ML_shiftrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench8::ML_shiftrhs.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "ML_BSSN_bench8::ML_trace_curvrhs","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for ML_BSSN_bench8::ML_trace_curvrhs.");
  return;
}

static void ML_BSSN_bench8_EvolutionAnalysisInterior_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3STR(ML_BSSN_bench8_EvolutionAnalysisInterior,
    ...
    vecimin,vecimax, CCTK_REAL_VEC_SIZE)
  {
    ...
    {
      dotbeta1 = 
        kmul(kmul(shiftGammaCoeffValue,kpow(alphaL,shiftAlphaPower)),knmsub(beta1L,betaDriverValue,Xt1L));
      
      dotbeta2 = 
        kmul(kmul(shiftGammaCoeffValue,kpow(alphaL,shiftAlphaPower)),knmsub(beta2L,betaDriverValue,Xt2L));
      
      dotbeta3 = 
        kmul(kmul(shiftGammaCoeffValue,kpow(alphaL,shiftAlphaPower)),knmsub(beta3L,betaDriverValue,Xt3L));
    }
    else
    {
      dotbeta1 = 
  ...
  CCTK_ENDLOOP3STR(ML_BSSN_bench8_EvolutionAnalysisInterior);
}
extern "C" void ML_BSSN_bench8_EvolutionAnalysisInterior(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_bench8_EvolutionAnalysisInterior
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_bench8_EvolutionAnalysisInterior);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ML_BSSN_bench8_EvolutionAnalysisInterior_Body");
  }
  if (cctk_iteration % ML_BSSN_bench8_EvolutionAnalysisInterior_calc_every != ML_BSSN_bench8_EvolutionAnalysisInterior_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    "grid::coordinates",
    "ML_BSSN_bench8::ML_curv",
    "ML_BSSN_bench8::ML_curvrhs",
    "ML_BSSN_bench8::ML_Gamma",
    "ML_BSSN_bench8::ML_Gammarhs",
    "ML_BSSN_bench8::ML_lapse",
    "ML_BSSN_bench8::ML_lapserhs",
    "ML_BSSN_bench8::ML_log_confac",
    "ML_BSSN_bench8::ML_log_confacrhs",
    "ML_BSSN_bench8::ML_metric",
    "ML_BSSN_bench8::ML_metricrhs",
    "ML_BSSN_bench8::ML_shift",
    "ML_BSSN_bench8::ML_shiftrhs",
    "ML_BSSN_bench8::ML_trace_curv",
    "ML_BSSN_bench8::ML_trace_curvrhs"};
  AssertGroupStorage(cctkGH, "ML_BSSN_bench8_EvolutionAnalysisInterior", 15, groups);
  
  switch (fdOrder)
  {
    case 2:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_bench8_EvolutionAnalysisInterior", 2, 2, 2);
      break;
    }
    
    case 4:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_bench8_EvolutionAnalysisInterior", 3, 3, 3);
      break;
    }
    
    case 6:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_bench8_EvolutionAnalysisInterior", 4, 4, 4);
      break;
    }
    
    case 8:
    {
      EnsureStencilFits(cctkGH, "ML_BSSN_bench8_EvolutionAnalysisInterior", 5, 5, 5);
      break;
    }
    default:
      CCTK_BUILTIN_UNREACHABLE();
  ...
  LoopOverInterior(cctkGH, ML_BSSN_bench8_EvolutionAnalysisInterior_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ML_BSSN_bench8_EvolutionAnalysisInterior_Body");
  }
}
