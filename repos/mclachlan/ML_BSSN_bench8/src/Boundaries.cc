...
extern "C" void ML_BSSN_bench8_CheckBoundaries(CCTK_ARGUMENTS)
{
#ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_bench8_CheckBoundaries
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_bench8_CheckBoundaries);
#else
...
extern "C" void ML_BSSN_bench8_SelectBoundConds(CCTK_ARGUMENTS)
{
#ifdef DECLARE_CCTK_ARGUMENTS_ML_BSSN_bench8_SelectBoundConds
  DECLARE_CCTK_ARGUMENTS_CHECKED(ML_BSSN_bench8_SelectBoundConds);
#else
  DECLARE_CCTK_ARGUMENTS;
#endif
  DECLARE_CCTK_PARAMETERS;
      ...
      CCTK_EQUALS(ML_log_confac_bound, "zero"  ) )
  {
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::ML_log_confac", ML_log_confac_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_log_confac_bound BC for ML_BSSN_bench8::ML_log_confac!");
  }
  ...
  {
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::ML_metric", ML_metric_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_metric_bound BC for ML_BSSN_bench8::ML_metric!");
  }
  ...
  {
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::ML_Gamma", ML_Gamma_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_Gamma_bound BC for ML_BSSN_bench8::ML_Gamma!");
  }
  ...
  {
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::ML_trace_curv", ML_trace_curv_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_trace_curv_bound BC for ML_BSSN_bench8::ML_trace_curv!");
  }
  ...
  {
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::ML_curv", ML_curv_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_curv_bound BC for ML_BSSN_bench8::ML_curv!");
  }
  ...
  {
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::ML_lapse", ML_lapse_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_lapse_bound BC for ML_BSSN_bench8::ML_lapse!");
  }
  ...
  {
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::ML_shift", ML_shift_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register ML_shift_bound BC for ML_BSSN_bench8::ML_shift!");
  }
      ...
      CCTK_EQUALS(phi_bound, "zero"  ) )
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::phi", phi_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register phi_bound BC for ML_BSSN_bench8::phi!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::gt11", gt11_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt11_bound BC for ML_BSSN_bench8::gt11!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::gt12", gt12_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt12_bound BC for ML_BSSN_bench8::gt12!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::gt13", gt13_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt13_bound BC for ML_BSSN_bench8::gt13!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::gt22", gt22_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt22_bound BC for ML_BSSN_bench8::gt22!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::gt23", gt23_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt23_bound BC for ML_BSSN_bench8::gt23!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::gt33", gt33_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register gt33_bound BC for ML_BSSN_bench8::gt33!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::Xt1", Xt1_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register Xt1_bound BC for ML_BSSN_bench8::Xt1!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::Xt2", Xt2_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register Xt2_bound BC for ML_BSSN_bench8::Xt2!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::Xt3", Xt3_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register Xt3_bound BC for ML_BSSN_bench8::Xt3!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::trK", trK_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register trK_bound BC for ML_BSSN_bench8::trK!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::At11", At11_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register At11_bound BC for ML_BSSN_bench8::At11!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::At12", At12_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register At12_bound BC for ML_BSSN_bench8::At12!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::At13", At13_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register At13_bound BC for ML_BSSN_bench8::At13!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::At22", At22_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register At22_bound BC for ML_BSSN_bench8::At22!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::At23", At23_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register At23_bound BC for ML_BSSN_bench8::At23!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::At33", At33_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register At33_bound BC for ML_BSSN_bench8::At33!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::alpha", alpha_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register alpha_bound BC for ML_BSSN_bench8::alpha!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::beta1", beta1_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register beta1_bound BC for ML_BSSN_bench8::beta1!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::beta2", beta2_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register beta2_bound BC for ML_BSSN_bench8::beta2!");
  }
  ...
  {
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, -1,
                      "ML_BSSN_bench8::beta3", beta3_bound);
    if (ierr < 0)
       CCTK_ERROR("Failed to register beta3_bound BC for ML_BSSN_bench8::beta3!");
  }
  ...
  if (CCTK_EQUALS(ML_log_confac_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_log_confac_bound, 
                      "ML_BSSN_bench8::ML_log_confac", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::ML_log_confac!");
  ...
  if (CCTK_EQUALS(ML_metric_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_metric_bound, 
                      "ML_BSSN_bench8::ML_metric", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::ML_metric!");
  ...
  if (CCTK_EQUALS(ML_Gamma_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_Gamma_bound, 
                      "ML_BSSN_bench8::ML_Gamma", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::ML_Gamma!");
  ...
  if (CCTK_EQUALS(ML_trace_curv_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_trace_curv_bound, 
                      "ML_BSSN_bench8::ML_trace_curv", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::ML_trace_curv!");
  ...
  if (CCTK_EQUALS(ML_curv_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_curv_bound, 
                      "ML_BSSN_bench8::ML_curv", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::ML_curv!");
  ...
  if (CCTK_EQUALS(ML_lapse_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_lapse_bound, 
                      "ML_BSSN_bench8::ML_lapse", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::ML_lapse!");
  ...
  if (CCTK_EQUALS(ML_shift_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_shift_bound, 
                      "ML_BSSN_bench8::ML_shift", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::ML_shift!");
  ...
  if (CCTK_EQUALS(phi_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "ML_BSSN_bench8::phi", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::phi!");
  ...
  if (CCTK_EQUALS(gt11_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt11_bound, 
                      "ML_BSSN_bench8::gt11", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::gt11!");
  ...
  if (CCTK_EQUALS(gt12_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt12_bound, 
                      "ML_BSSN_bench8::gt12", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::gt12!");
  ...
  if (CCTK_EQUALS(gt13_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt13_bound, 
                      "ML_BSSN_bench8::gt13", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::gt13!");
  ...
  if (CCTK_EQUALS(gt22_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt22_bound, 
                      "ML_BSSN_bench8::gt22", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::gt22!");
  ...
  if (CCTK_EQUALS(gt23_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt23_bound, 
                      "ML_BSSN_bench8::gt23", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::gt23!");
  ...
  if (CCTK_EQUALS(gt33_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt33_bound, 
                      "ML_BSSN_bench8::gt33", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::gt33!");
  ...
  if (CCTK_EQUALS(Xt1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt1_bound, 
                      "ML_BSSN_bench8::Xt1", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::Xt1!");
  ...
  if (CCTK_EQUALS(Xt2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt2_bound, 
                      "ML_BSSN_bench8::Xt2", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::Xt2!");
  ...
  if (CCTK_EQUALS(Xt3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt3_bound, 
                      "ML_BSSN_bench8::Xt3", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::Xt3!");
  ...
  if (CCTK_EQUALS(trK_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_trK_bound, 
                      "ML_BSSN_bench8::trK", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::trK!");
  ...
  if (CCTK_EQUALS(At11_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At11_bound, 
                      "ML_BSSN_bench8::At11", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::At11!");
  ...
  if (CCTK_EQUALS(At12_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At12_bound, 
                      "ML_BSSN_bench8::At12", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::At12!");
  ...
  if (CCTK_EQUALS(At13_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At13_bound, 
                      "ML_BSSN_bench8::At13", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::At13!");
  ...
  if (CCTK_EQUALS(At22_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At22_bound, 
                      "ML_BSSN_bench8::At22", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::At22!");
  ...
  if (CCTK_EQUALS(At23_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At23_bound, 
                      "ML_BSSN_bench8::At23", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::At23!");
  ...
  if (CCTK_EQUALS(At33_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At33_bound, 
                      "ML_BSSN_bench8::At33", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::At33!");
  ...
  if (CCTK_EQUALS(alpha_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_alpha_bound, 
                      "ML_BSSN_bench8::alpha", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::alpha!");
  ...
  if (CCTK_EQUALS(beta1_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta1_bound, 
                      "ML_BSSN_bench8::beta1", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::beta1!");
  ...
  if (CCTK_EQUALS(beta2_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta2_bound, 
                      "ML_BSSN_bench8::beta2", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::beta2!");
  ...
  if (CCTK_EQUALS(beta3_bound, "radiative"))
  {
   /* select radiation boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta3_bound, 
                      "ML_BSSN_bench8::beta3", "Radiation");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Radiation BC for ML_BSSN_bench8::beta3!");
  ...
  if (CCTK_EQUALS(ML_log_confac_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_log_confac_bound, 
                      "ML_BSSN_bench8::ML_log_confac", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_BSSN_bench8::ML_log_confac!");
  ...
  if (CCTK_EQUALS(ML_metric_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_metric_bound, 
                      "ML_BSSN_bench8::ML_metric", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_BSSN_bench8::ML_metric!");
  ...
  if (CCTK_EQUALS(ML_Gamma_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_Gamma_bound, 
                      "ML_BSSN_bench8::ML_Gamma", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_BSSN_bench8::ML_Gamma!");
  ...
  if (CCTK_EQUALS(ML_trace_curv_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_trace_curv_bound, 
                      "ML_BSSN_bench8::ML_trace_curv", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_BSSN_bench8::ML_trace_curv!");
  ...
  if (CCTK_EQUALS(ML_curv_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_curv_bound, 
                      "ML_BSSN_bench8::ML_curv", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_BSSN_bench8::ML_curv!");
  ...
  if (CCTK_EQUALS(ML_lapse_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_lapse_bound, 
                      "ML_BSSN_bench8::ML_lapse", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_BSSN_bench8::ML_lapse!");
  ...
  if (CCTK_EQUALS(ML_shift_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, 1, handle_ML_shift_bound, 
                      "ML_BSSN_bench8::ML_shift", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Failed to register Scalar BC for ML_BSSN_bench8::ML_shift!");
  ...
  if (CCTK_EQUALS(phi_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_phi_bound, 
                      "ML_BSSN_bench8::phi", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::phi!");
  ...
  if (CCTK_EQUALS(gt11_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt11_bound, 
                      "ML_BSSN_bench8::gt11", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::gt11!");
  ...
  if (CCTK_EQUALS(gt12_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt12_bound, 
                      "ML_BSSN_bench8::gt12", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::gt12!");
  ...
  if (CCTK_EQUALS(gt13_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt13_bound, 
                      "ML_BSSN_bench8::gt13", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::gt13!");
  ...
  if (CCTK_EQUALS(gt22_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt22_bound, 
                      "ML_BSSN_bench8::gt22", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::gt22!");
  ...
  if (CCTK_EQUALS(gt23_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt23_bound, 
                      "ML_BSSN_bench8::gt23", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::gt23!");
  ...
  if (CCTK_EQUALS(gt33_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_gt33_bound, 
                      "ML_BSSN_bench8::gt33", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::gt33!");
  ...
  if (CCTK_EQUALS(Xt1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt1_bound, 
                      "ML_BSSN_bench8::Xt1", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::Xt1!");
  ...
  if (CCTK_EQUALS(Xt2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt2_bound, 
                      "ML_BSSN_bench8::Xt2", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::Xt2!");
  ...
  if (CCTK_EQUALS(Xt3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_Xt3_bound, 
                      "ML_BSSN_bench8::Xt3", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::Xt3!");
  ...
  if (CCTK_EQUALS(trK_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_trK_bound, 
                      "ML_BSSN_bench8::trK", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::trK!");
  ...
  if (CCTK_EQUALS(At11_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At11_bound, 
                      "ML_BSSN_bench8::At11", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::At11!");
  ...
  if (CCTK_EQUALS(At12_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At12_bound, 
                      "ML_BSSN_bench8::At12", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::At12!");
  ...
  if (CCTK_EQUALS(At13_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At13_bound, 
                      "ML_BSSN_bench8::At13", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::At13!");
  ...
  if (CCTK_EQUALS(At22_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At22_bound, 
                      "ML_BSSN_bench8::At22", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::At22!");
  ...
  if (CCTK_EQUALS(At23_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At23_bound, 
                      "ML_BSSN_bench8::At23", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::At23!");
  ...
  if (CCTK_EQUALS(At33_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_At33_bound, 
                      "ML_BSSN_bench8::At33", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::At33!");
  ...
  if (CCTK_EQUALS(alpha_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_alpha_bound, 
                      "ML_BSSN_bench8::alpha", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::alpha!");
  ...
  if (CCTK_EQUALS(beta1_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta1_bound, 
                      "ML_BSSN_bench8::beta1", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::beta1!");
  ...
  if (CCTK_EQUALS(beta2_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta2_bound, 
                      "ML_BSSN_bench8::beta2", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::beta2!");
  ...
  if (CCTK_EQUALS(beta3_bound, "scalar"))
  {
   /* select scalar boundary condition */
    ...
    ierr = KrancBdy_SelectVarForBC(cctkGH, CCTK_ALL_FACES, 1, handle_beta3_bound, 
                      "ML_BSSN_bench8::beta3", "scalar");
  
    if (ierr < 0)
       CCTK_ERROR("Error in registering Scalar BC for ML_BSSN_bench8::beta3!");
...
#$bound$#ML_BSSN_bench8::ML_log_confac_bound       = "skip"
#$bound$#ML_BSSN_bench8::ML_log_confac_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::ML_log_confac_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::ML_log_confac_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::ML_metric_bound       = "skip"
#$bound$#ML_BSSN_bench8::ML_metric_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::ML_metric_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::ML_metric_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::ML_Gamma_bound       = "skip"
#$bound$#ML_BSSN_bench8::ML_Gamma_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::ML_Gamma_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::ML_Gamma_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::ML_trace_curv_bound       = "skip"
#$bound$#ML_BSSN_bench8::ML_trace_curv_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::ML_trace_curv_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::ML_trace_curv_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::ML_curv_bound       = "skip"
#$bound$#ML_BSSN_bench8::ML_curv_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::ML_curv_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::ML_curv_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::ML_lapse_bound       = "skip"
#$bound$#ML_BSSN_bench8::ML_lapse_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::ML_lapse_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::ML_lapse_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::ML_shift_bound       = "skip"
#$bound$#ML_BSSN_bench8::ML_shift_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::ML_shift_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::ML_shift_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::phi_bound       = "skip"
#$bound$#ML_BSSN_bench8::phi_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::phi_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::phi_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::gt11_bound       = "skip"
#$bound$#ML_BSSN_bench8::gt11_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::gt11_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::gt11_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::gt12_bound       = "skip"
#$bound$#ML_BSSN_bench8::gt12_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::gt12_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::gt12_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::gt13_bound       = "skip"
#$bound$#ML_BSSN_bench8::gt13_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::gt13_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::gt13_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::gt22_bound       = "skip"
#$bound$#ML_BSSN_bench8::gt22_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::gt22_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::gt22_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::gt23_bound       = "skip"
#$bound$#ML_BSSN_bench8::gt23_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::gt23_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::gt23_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::gt33_bound       = "skip"
#$bound$#ML_BSSN_bench8::gt33_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::gt33_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::gt33_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::Xt1_bound       = "skip"
#$bound$#ML_BSSN_bench8::Xt1_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::Xt1_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::Xt1_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::Xt2_bound       = "skip"
#$bound$#ML_BSSN_bench8::Xt2_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::Xt2_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::Xt2_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::Xt3_bound       = "skip"
#$bound$#ML_BSSN_bench8::Xt3_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::Xt3_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::Xt3_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::trK_bound       = "skip"
#$bound$#ML_BSSN_bench8::trK_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::trK_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::trK_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::At11_bound       = "skip"
#$bound$#ML_BSSN_bench8::At11_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::At11_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::At11_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::At12_bound       = "skip"
#$bound$#ML_BSSN_bench8::At12_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::At12_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::At12_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::At13_bound       = "skip"
#$bound$#ML_BSSN_bench8::At13_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::At13_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::At13_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::At22_bound       = "skip"
#$bound$#ML_BSSN_bench8::At22_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::At22_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::At22_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::At23_bound       = "skip"
#$bound$#ML_BSSN_bench8::At23_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::At23_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::At23_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::At33_bound       = "skip"
#$bound$#ML_BSSN_bench8::At33_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::At33_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::At33_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::alpha_bound       = "skip"
#$bound$#ML_BSSN_bench8::alpha_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::alpha_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::alpha_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::beta1_bound       = "skip"
#$bound$#ML_BSSN_bench8::beta1_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::beta1_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::beta1_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::beta2_bound       = "skip"
#$bound$#ML_BSSN_bench8::beta2_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::beta2_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::beta2_bound_scalar = 0.0

#$bound$#ML_BSSN_bench8::beta3_bound       = "skip"
#$bound$#ML_BSSN_bench8::beta3_bound_speed = 1.0
#$bound$#ML_BSSN_bench8::beta3_bound_limit = 0.0
#$bound$#ML_BSSN_bench8::beta3_bound_scalar = 0.0
