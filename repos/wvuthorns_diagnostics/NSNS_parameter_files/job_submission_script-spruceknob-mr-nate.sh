...
#PBS -l nodes=4:ppn=4:ivy,walltime=4:00:00,pvmem=15gb
#PBS -n
...
export NPROCS=8  # This is total MPI processes so if 2 nodes and 4 MPI processes per node this variable will be 8
