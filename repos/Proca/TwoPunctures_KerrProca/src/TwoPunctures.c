/* TwoPunctures_KerrProca:  File  "TwoPunctures.c"*/
...
//      Define Aphi, Ei in Cart Coords and E2
//      see Eqs (63)-(64) in the notes
        CCTK_REAL Ei[3], AphS, E2;
        TPKP_Compute_Aphi( xx, yy, zz, Ei, &AphS, &E2 );
...
//      /* Proca variables */
//      we rescale also with det g; see Eq. (73) in the notes
        Zeta[ind]  = 0;

        Aphi[ind]  = AphS / pow(psi1, 6) / sqrt(fabs( detgK ));
