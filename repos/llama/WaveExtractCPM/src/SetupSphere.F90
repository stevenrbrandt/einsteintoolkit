...
subroutine WavExtrCPM_SetupSphere(CCTK_ARGUMENTS)
  ...
  call CCTK_GrouplbndGN(status, cctkGH, 2, lbnd,"WaveExtractCPM::surface_arrays")
  if ( status .lt. 0 ) then
  ...
  do i=1,maximum_detector_number
    ...
    !print*,'WaveExtractCPM: ntheta.',int_ntheta(i)
    !print*,'WaveExtractCPM: nphi.',int_nphi(i)
    !print*,'WaveExtractCPM: detector_radius.',detector_radius(i)
  end do
...
end subroutine WavExtrCPM_SetupSphere
